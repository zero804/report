...
public class AceAccessMap__ implements net.datenwerke.entityservices.metadatagenerator.interfaces.EntityMetadataProvider {

	public static final String access = "access";
	public static final String id = "id";
	public static final String securee = "securee";
