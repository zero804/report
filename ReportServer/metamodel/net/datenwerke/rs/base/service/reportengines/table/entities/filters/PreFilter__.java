...
public class PreFilter__ implements net.datenwerke.entityservices.metadatagenerator.interfaces.EntityMetadataProvider {

	public static final String description = "description";
	public static final String id = "id";
	public static final String rootBlock = "rootBlock";
	public static final String rootBlockType = "rootBlockType";
