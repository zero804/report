...
public class DtoInformation {
	...
	public DtoInformation(PosoAnalizer posoAnalizer,
	...
	public Long getSerialVersionUID(){
		return posoAnalizer.getGenerateDtoAnnotation().dtoSerialVersionUID() == 0 ?
				1L : posoAnalizer.getGenerateDtoAnnotation().dtoSerialVersionUID();
	}
	...
	public DeclaredType getTypeDescriptionMsgInterface() {
		...
		for(ExecutableElement key : gdAnno.getElementValues().keySet()){
			if(key.toString().equals("typeDescriptionMsg()")){
				...
				System.out.println("lalala: " + getClassName() + " -- " + String.valueOf(value) + " -- " + value.getClass());
