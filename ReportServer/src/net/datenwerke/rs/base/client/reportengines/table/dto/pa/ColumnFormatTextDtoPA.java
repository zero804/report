...
@CorrespondingPoso(net.datenwerke.rs.base.service.reportengines.table.entities.format.ColumnFormatText.class)
public interface ColumnFormatTextDtoPA extends ColumnFormatDtoPA {


	public static final ColumnFormatTextDtoPA INSTANCE = GWT.create(ColumnFormatTextDtoPA.class);
