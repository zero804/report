...
public class PreviewEnhancerHook implements TableReportPreviewCellEnhancerHook {
	...
	@Override
	public boolean enhanceMenu(final TableReportPreviewView view, Menu menu, TableReportDto report, final ColumnDto column, final String value, String rawValue, String[] rowValues) {
