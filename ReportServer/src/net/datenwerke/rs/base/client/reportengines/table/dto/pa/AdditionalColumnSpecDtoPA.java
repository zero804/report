...
@CorrespondingPoso(net.datenwerke.rs.base.service.reportengines.table.entities.AdditionalColumnSpec.class)
public interface AdditionalColumnSpecDtoPA extends ColumnDtoPA {


	public static final AdditionalColumnSpecDtoPA INSTANCE = GWT.create(AdditionalColumnSpecDtoPA.class);
