...
@CorrespondingPoso(net.datenwerke.rs.base.service.datasources.connectors.TextDatasourceConnector.class)
public interface TextDatasourceConnectorDtoPA extends DatasourceConnectorDtoPA {


	public static final TextDatasourceConnectorDtoPA INSTANCE = GWT.create(TextDatasourceConnectorDtoPA.class);


	/* Properties */
	public ValueProvider<TextDatasourceConnectorDto,String> data();
