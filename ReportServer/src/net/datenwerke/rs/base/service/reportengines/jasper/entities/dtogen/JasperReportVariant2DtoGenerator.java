...
/**
 * Poso2DtoGenerator for JasperReportVariant
 *
 * This file was automatically created by DtoAnnotationProcessor, version 0.1
 */
@GeneratedType("net.datenwerke.dtoservices.dtogenerator.DtoAnnotationProcessor")
public class JasperReportVariant2DtoGenerator implements Poso2DtoGenerator<JasperReportVariant,JasperReportVariantDtoDec> {
	...
	@Inject
	public JasperReportVariant2DtoGenerator(
	...
	public JasperReportVariantDtoDec instantiateDto(JasperReportVariant poso)  {
		JasperReportVariantDtoDec dto = new JasperReportVariantDtoDec();
	...
	public JasperReportVariantDtoDec createDto(JasperReportVariant poso, DtoView here, DtoView referenced)  {
		/* create dto and set view */
		final JasperReportVariantDtoDec dto = new JasperReportVariantDtoDec();
		dto.setDtoView(here);
