...
/**
 * Poso2DtoGenerator for TableReportVariant
 *
...
public class TableReportVariant2DtoGenerator implements Poso2DtoGenerator<TableReportVariant,TableReportVariantDtoDec> {
	...
	@Inject
	public TableReportVariant2DtoGenerator(
	...
	public TableReportVariantDtoDec instantiateDto(TableReportVariant poso)  {
		TableReportVariantDtoDec dto = new TableReportVariantDtoDec();
	...
	public TableReportVariantDtoDec createDto(TableReportVariant poso, DtoView here, DtoView referenced)  {
		/* create dto and set view */
		final TableReportVariantDtoDec dto = new TableReportVariantDtoDec();
		dto.setDtoView(here);
