...
public class Column2DtoGenerator implements Poso2DtoGenerator<Column,ColumnDtoDec> {
	...
	public ColumnDtoDec instantiateDto(Column poso)  {
		ColumnDtoDec dto = new ColumnDtoDec();
	...
	public ColumnDtoDec createDto(Column poso, DtoView here, DtoView referenced)  {
		/* create dto and set view */
		final ColumnDtoDec dto = new ColumnDtoDec();
		dto.setDtoView(here);
