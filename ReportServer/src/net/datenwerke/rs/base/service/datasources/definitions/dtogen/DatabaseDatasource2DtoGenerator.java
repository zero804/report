...
/**
 * Poso2DtoGenerator for DatabaseDatasource
 *
...
public class DatabaseDatasource2DtoGenerator implements Poso2DtoGenerator<DatabaseDatasource,DatabaseDatasourceDto> {
	...
	@Inject
	public DatabaseDatasource2DtoGenerator(
	...
	public DatabaseDatasourceDto instantiateDto(DatabaseDatasource poso)  {
		DatabaseDatasourceDto dto = new DatabaseDatasourceDto();
	...
	public DatabaseDatasourceDto createDto(DatabaseDatasource poso, DtoView here, DtoView referenced)  {
		/* create dto and set view */
		final DatabaseDatasourceDto dto = new DatabaseDatasourceDto();
		dto.setDtoView(here);
