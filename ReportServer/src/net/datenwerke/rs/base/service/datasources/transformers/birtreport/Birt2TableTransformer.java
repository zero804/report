...
public class Birt2TableTransformer extends Birt2XTransformer<TableDataSource> {

	@Inject
	public Birt2TableTransformer(
	...
	public boolean consumes(DatasourceContainerProvider containerProvider, Class<?> dst) {
		...
		return (null != container && container.getDatasource() instanceof BirtReportDatasourceDefinition && dst.isAssignableFrom(TableDataSource.class));
	}
