...
public class ListPropertyCommand implements ReportModSubCommandHook {
	...
	@CliHelpMessage(
		...
		name = BASE_COMMAND,
		description = "commandReportmod_sub_listProperties_description",
		nonOptArgs = {
		...
		try{
			...
			if(null != propertyName){
				...
				if(property instanceof ReportStringProperty){
					model.addDataRow(new RSStringTableRow(property.getName(), ((ReportStringProperty) property).getStrValue()));
