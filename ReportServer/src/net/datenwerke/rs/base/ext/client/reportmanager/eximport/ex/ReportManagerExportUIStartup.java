...
import net.datenwerke.rs.base.ext.client.reportmanager.eximport.ex.hookers.ExportButtonHook;
...
public class ReportManagerExportUIStartup {

	@Inject
	public ReportManagerExportUIStartup(
