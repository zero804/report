...
//		form.addCondition(modeKey, radioCheckCond, new ShowHideFieldAction(boxPackColSizeKey));
	...
	@Override
	public Widget doGetEditComponentForInstance(final FileSelectionParameterInstanceDto instance, Collection<ParameterInstanceDto> relevantInstances, final FileSelectionParameterDefinitionDto definition, boolean initial, int labelWidth, String executeReportToken) {
