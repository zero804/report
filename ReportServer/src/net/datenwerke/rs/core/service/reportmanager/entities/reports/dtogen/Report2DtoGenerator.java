...
import net.datenwerke.rs.core.service.reportmanager.entities.reports.dtogen.Report2DtoGenerator;
import net.datenwerke.rs.utils.misc.StringEscapeUtils;
import org.apache.commons.lang.StringUtils;

/**
 * Poso2DtoGenerator for Report
 *
 * This file was automatically created by DtoAnnotationProcessor, version 0.1
 */
@GeneratedType("net.datenwerke.dtoservices.dtogenerator.DtoAnnotationProcessor")
public class Report2DtoGenerator implements Poso2DtoGenerator<Report,ReportDtoDec> {
	...
	public ReportDtoDec instantiateDto(Report poso)  {
		ReportDtoDec dto = new ReportDtoDec();
	...
	public ReportDtoDec createDto(Report poso, DtoView here, DtoView referenced)  {
		/* create dto and set view */
		final ReportDtoDec dto = new ReportDtoDec();
		dto.setDtoView(here);
