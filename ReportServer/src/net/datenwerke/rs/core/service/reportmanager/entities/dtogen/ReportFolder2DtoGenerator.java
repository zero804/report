...
import net.datenwerke.rs.core.service.reportmanager.entities.dtogen.ReportFolder2DtoGenerator;
import net.datenwerke.rs.utils.misc.StringEscapeUtils;
import org.apache.commons.lang.StringUtils;

/**
 * Poso2DtoGenerator for ReportFolder
 *
 * This file was automatically created by DtoAnnotationProcessor, version 0.1
 */
@GeneratedType("net.datenwerke.dtoservices.dtogenerator.DtoAnnotationProcessor")
public class ReportFolder2DtoGenerator implements Poso2DtoGenerator<ReportFolder,ReportFolderDto> {
	...
	private final net.datenwerke.rs.core.service.reportmanager.entities.post.ReportFolder2DtoPostProcessor postProcessor_3;
	private final Provider<DtoService> dtoServiceProvider;

	@Inject
	public ReportFolder2DtoGenerator(
		...
		net.datenwerke.rs.core.service.reportmanager.entities.post.ReportFolder2DtoPostProcessor postProcessor_3	){
	...
	public ReportFolderDto instantiateDto(ReportFolder poso)  {
	...
	public ReportFolderDto createDto(ReportFolder poso, DtoView here, DtoView referenced)  {
		/* create dto and set view */
		final ReportFolderDto dto = new ReportFolderDto();
		dto.setDtoView(here);
