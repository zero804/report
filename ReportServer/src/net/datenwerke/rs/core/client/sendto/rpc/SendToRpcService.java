...
public interface SendToRpcService extends RemoteService {
	...
	String sendTo(ReportDto report, String executorToken, String id, String format, List<ReportExecutionConfigDto> formatConfig, HashMap<String, String> values) throws ServerCallFailedException;
