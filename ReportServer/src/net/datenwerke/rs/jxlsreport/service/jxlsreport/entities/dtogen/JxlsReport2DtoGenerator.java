...
import net.datenwerke.rs.jxlsreport.service.jxlsreport.entities.dtogen.JxlsReport2DtoGenerator;
import net.datenwerke.rs.utils.misc.StringEscapeUtils;
import org.apache.commons.lang.StringUtils;

/**
 * Poso2DtoGenerator for JxlsReport
 *
 * This file was automatically created by DtoAnnotationProcessor, version 0.1
 */
@GeneratedType("net.datenwerke.dtoservices.dtogenerator.DtoAnnotationProcessor")
public class JxlsReport2DtoGenerator implements Poso2DtoGenerator<JxlsReport,JxlsReportDtoDec> {
	...
	@Inject
	public JxlsReport2DtoGenerator(
	...
	public JxlsReportDtoDec instantiateDto(JxlsReport poso)  {
		JxlsReportDtoDec dto = new JxlsReportDtoDec();
	...
	public JxlsReportDtoDec createDto(JxlsReport poso, DtoView here, DtoView referenced)  {
		/* create dto and set view */
		final JxlsReportDtoDec dto = new JxlsReportDtoDec();
		dto.setDtoView(here);
