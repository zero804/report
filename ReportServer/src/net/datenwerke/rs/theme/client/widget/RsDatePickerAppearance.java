...
public class RsDatePickerAppearance extends Css3DatePickerAppearance {
	...
	public void render(SafeHtmlBuilder sb) {
		...
		sb.appendHtmlConstant("<td class=" + style.monthLeft() + "><i class=\"fa fa-chevron-left rs-date-month-btn " + style.monthLeftButton() + "\"></i></td>");
		...
		sb.appendHtmlConstant("<td class=\"" + style.monthButtonText() + " rs-datepicker-month\"></td><td><i class=\"fa fa-angle-down rs-date-month-btn " + style.downIcon() + "\"></i></td></tr></table>");

		sb.appendHtmlConstant("</td>");
		sb.appendHtmlConstant("<td class=" + style.monthRight() + "><i class=\"fa fa-chevron-right rs-date-month-btn " + style.monthRightButton() + "\"></i></td></tr></table>");
	...
	public void renderMonthPicker(SafeHtmlBuilder sb, DatePickerMessages messages, String[] monthNames) {
		...
		for (int i = 0; i < 6; i++) {
			sb.appendHtmlConstant("<tr><td class='" + style.monthPickerItem() + " " + style.month() + "'><a class='" + style.monthPickerItemInner() + " rs-datepicker-month' href=#>");
			sb.appendHtmlConstant(monthNames[i]);
			sb.appendHtmlConstant("</a></td>");
			sb.appendHtmlConstant("<td class='" + style.monthPickerItem() + " " + style.month() + " " + style.monthSep() + "'><a class='" + style.monthPickerItemInner() + " rs-datepicker-month' href=#>");
			sb.appendHtmlConstant(monthNames[i + 6]);
			sb.appendHtmlConstant("</a></td>");
			if (i == 0) {
				sb.appendHtmlConstant("<td class=" + style.yearButton() + " align=center>");
				sb.appendHtmlConstant("<i class=\"fa fa-chevron-left rs-date-month-btn " + style.leftYearIcon() + "\"></i>");
				sb.appendHtmlConstant("</td><td class='" + style.yearButton() + "' align=center>");
				sb.appendHtmlConstant("<i class=\"fa fa-chevron-right rs-date-month-btn " + style.rightYearIcon() + "\"></i>");
				sb.appendHtmlConstant("</td></tr>");
			} else {
				sb.appendHtmlConstant("<td class='" + style.monthPickerItem() + " " + style.year()
						+ "'><a class='" + style.monthPickerItemInner() + " rs-datepicker-month ' href='#'></a></td><td class='" + style.monthPickerItem() + " " + style.year()
						+ "'><a class='" + style.monthPickerItemInner() + " rs-datepicker-month ' href='#'></a></td></tr>");
			}
		}
