...
public class RsToolIcons extends Tools {

	public static class Css3ToolResources implements ToolResources {

		public static class RsToolStyle implements ToolStyle {
			@Override
