...
public class InstanceDescriptionServiceImpl implements InstanceDescriptionService {
	...
	@Inject
	public InstanceDescriptionServiceImpl(
	...
	public InstanceDescription getDescriptionFor(Object object) {
		...
		net.datenwerke.rs.utils.instancedescription.annotations.InstanceDescription instanceDescriptor = object.getClass().getAnnotation(net.datenwerke.rs.utils.instancedescription.annotations.InstanceDescription.class);
	...
	private String getIcon(Object object,
		...
		/* serach for method with icon provider */
	...
	private String getObjectType(net.datenwerke.rs.utils.instancedescription.annotations.InstanceDescription instanceDescriptor) {
		if(null == instanceDescriptor)
			return "unknown";
	...
	private SimpleJuel prepareJuel(
			Object object, 
			net.datenwerke.rs.utils.instancedescription.annotations.InstanceDescription instanceDescriptor) {
