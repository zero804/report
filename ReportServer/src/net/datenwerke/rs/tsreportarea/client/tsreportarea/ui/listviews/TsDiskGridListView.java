...
public class TsDiskGridListView implements TsFavoriteListViewHook {
	...
	@Inject
	public TsDiskGridListView(
		TsDiskUIService favoriteService
		){
	...
	public TsDiskListView getListView(final TsDiskMainComponent mainComponent) {
		/* create model */
		ColumnModel<AbstractTsDiskNodeDto> cm = new ColumnModel<AbstractTsDiskNodeDto>(favoriteService.createGridColumnConfig(AbstractTsDiskNodeDto.class));
