...
public class BirtReportDatasourceConfigConfigurator implements DatasourceDefinitionConfigConfigurator {
	...
	@Override
	public Iterable<Widget> getOptionalAdditionalFormfields(DatasourceDefinitionConfigDto config, DatasourceDefinitionDto datasourceDefinitionDto, final DatasourceSelectionField datasourceSelectionField, final DatasourceContainerProviderDto datasourceContainerProvider) {
		...
		reportKey = form.addField(BirtReportDto.class, BirtReportDatasourceConfigDtoPA.INSTANCE.report(),BirtMessages.INSTANCE.datasourceReport(), new SFFCGenericTreeNode() { 
		...
		targetTypeKey = form.addField(List.class,  BirtReportDatasourceConfigDtoPA.INSTANCE.targetType(), BirtMessages.INSTANCE.datasourceType(), new SFFCEnumList(BirtReportDatasourceTargetTypeDto.class){
			@Override
		...
		wrapperKey = form.addField(String.class, BirtReportDatasourceConfigDtoPA.INSTANCE.queryWrapper(), BirtMessages.INSTANCE.queryWrapper(), new SFFCCodeMirror(){
			@Override
	...
	public boolean consumes(DatasourceDefinitionDto datasourceDefinitionDto, DatasourceDefinitionConfigDto datasourceConfig) {
		return (null != datasourceConfig && datasourceDefinitionDto instanceof BirtReportDatasourceDefinitionDto && datasourceConfig instanceof BirtReportDatasourceConfigDto);
	}
