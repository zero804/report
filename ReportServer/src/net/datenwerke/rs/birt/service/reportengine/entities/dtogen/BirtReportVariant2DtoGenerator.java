...
/**
 * Poso2DtoGenerator for BirtReportVariant
 *
...
public class BirtReportVariant2DtoGenerator implements Poso2DtoGenerator<BirtReportVariant,BirtReportVariantDtoDec> {
	...
	@Inject
	public BirtReportVariant2DtoGenerator(
	...
	public BirtReportVariantDtoDec instantiateDto(BirtReportVariant poso)  {
		BirtReportVariantDtoDec dto = new BirtReportVariantDtoDec();
	...
	public BirtReportVariantDtoDec createDto(BirtReportVariant poso, DtoView here, DtoView referenced)  {
		/* create dto and set view */
		final BirtReportVariantDtoDec dto = new BirtReportVariantDtoDec();
		dto.setDtoView(here);
