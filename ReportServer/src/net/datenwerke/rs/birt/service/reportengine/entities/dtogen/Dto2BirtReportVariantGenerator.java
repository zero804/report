...
/**
 * Dto2PosoGenerator for BirtReportVariant
 *
...
public class Dto2BirtReportVariantGenerator implements Dto2PosoGenerator<BirtReportVariantDto,BirtReportVariant> {
	...
	@Inject
	public Dto2BirtReportVariantGenerator(
	...
	public BirtReportVariant loadPoso(BirtReportVariantDto dto)  {
		if(null == dto)
			return null;
		...
		BirtReportVariant poso = entityManager.find(BirtReportVariant.class, id);
		return poso;
	}

	public BirtReportVariant instantiatePoso()  {
		BirtReportVariant poso = new BirtReportVariant();
		return poso;
	}

	public BirtReportVariant createPoso(BirtReportVariantDto dto)  throws ExpectedException {
		BirtReportVariant poso = new BirtReportVariant();
	...
	public BirtReportVariant createUnmanagedPoso(BirtReportVariantDto dto)  throws ExpectedException {
		BirtReportVariant poso = new BirtReportVariant();
	...
	public void mergePoso(BirtReportVariantDto dto, final BirtReportVariant poso)  throws ExpectedException {
		if(dto.isDtoProxy())
	...
	protected void mergePlainDto2Poso(BirtReportVariantDto dto, final BirtReportVariant poso)  throws ExpectedException {
		/*  set description */
	...
	protected void mergeProxy2Poso(BirtReportVariantDto dto, final BirtReportVariant poso)  throws ExpectedException {
		/*  set description */
	...
	public void mergeUnmanagedPoso(BirtReportVariantDto dto, final BirtReportVariant poso)  throws ExpectedException {
		if(dto.isDtoProxy())
	...
	protected void mergePlainDto2UnmanagedPoso(BirtReportVariantDto dto, final BirtReportVariant poso)  throws ExpectedException {
		/*  set description */
		poso.setDescription(dto.getDescription() );
	...
	protected void mergeProxy2UnmanagedPoso(BirtReportVariantDto dto, final BirtReportVariant poso)  throws ExpectedException {
		/*  set description */
		if(dto.isDescriptionModified()){
			poso.setDescription(dto.getDescription() );
		}
	...
	public BirtReportVariant loadAndMergePoso(BirtReportVariantDto dto)  throws ExpectedException {
		BirtReportVariant poso = loadPoso(dto);
		if(null != poso){
			mergePoso(dto, poso);
			return poso;
		}
	...
	public void postProcessCreate(BirtReportVariantDto dto, BirtReportVariant poso)  {

		this.postProcessor_1.posoCreated(dto, poso);
	}


	public void postProcessCreateUnmanaged(BirtReportVariantDto dto, BirtReportVariant poso)  {

		this.postProcessor_1.posoCreatedUnmanaged(dto, poso);
	}


	public void postProcessLoad(BirtReportVariantDto dto, BirtReportVariant poso)  {

		this.postProcessor_1.posoLoaded(dto, poso);
	}


	public void postProcessMerge(BirtReportVariantDto dto, BirtReportVariant poso)  {

		this.postProcessor_1.posoMerged(dto, poso);
	}


	public void postProcessInstantiate(BirtReportVariant poso)  {

		this.postProcessor_1.posoInstantiated(poso);
	}


	public boolean validateKeyProperty(BirtReportVariantDto dto, BirtReportVariant poso)  throws ExpectedException {
