...
/**
 * Poso2DtoGenerator for BirtReport
 *
 * This file was automatically created by DtoAnnotationProcessor, version 0.1
 */
@GeneratedType("net.datenwerke.dtoservices.dtogenerator.DtoAnnotationProcessor")
public class BirtReport2DtoGenerator implements Poso2DtoGenerator<BirtReport,BirtReportDtoDec> {
	...
	@Inject
	public BirtReport2DtoGenerator(
	...
	public BirtReportDtoDec instantiateDto(BirtReport poso)  {
		BirtReportDtoDec dto = new BirtReportDtoDec();
	...
	public BirtReportDtoDec createDto(BirtReport poso, DtoView here, DtoView referenced)  {
		/* create dto and set view */
		final BirtReportDtoDec dto = new BirtReportDtoDec();
		dto.setDtoView(here);
		...
		if(here.compareTo(DtoView.NORMAL) >= 0){
			...
			/*  set reportFile */
			Object tmpDtoBirtReportFileDtogetReportFile = dtoServiceProvider.get().createDto(poso.getReportFile(), here, referenced);
			dto.setReportFile((BirtReportFileDto)tmpDtoBirtReportFileDtogetReportFile);
			/* ask for a dto with higher view if generated */
			((DtoMainService)dtoServiceProvider.get()).getCreationHelper().onDtoCreation(tmpDtoBirtReportFileDtogetReportFile, poso.getReportFile(), new net.datenwerke.gxtdto.server.dtomanager.CallbackOnDtoCreation(){
				public void callback(Object refDto){
					if(null != refDto)
						dto.setReportFile((BirtReportFileDto)refDto);
				}
			});
