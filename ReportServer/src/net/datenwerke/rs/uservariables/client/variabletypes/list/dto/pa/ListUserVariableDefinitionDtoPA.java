...
@CorrespondingPoso(net.datenwerke.rs.uservariables.service.variabletypes.list.ListUserVariableDefinition.class)
public interface ListUserVariableDefinitionDtoPA extends UserVariableDefinitionDtoPA {


	public static final ListUserVariableDefinitionDtoPA INSTANCE = GWT.create(ListUserVariableDefinitionDtoPA.class);
