...
import net.datenwerke.rs.saiku.service.saiku.entities.dtogen.SaikuReport2DtoGenerator;
import net.datenwerke.rs.utils.misc.StringEscapeUtils;
import org.apache.commons.lang.StringUtils;

/**
 * Poso2DtoGenerator for SaikuReport
 *
 * This file was automatically created by DtoAnnotationProcessor, version 0.1
 */
@GeneratedType("net.datenwerke.dtoservices.dtogenerator.DtoAnnotationProcessor")
public class SaikuReport2DtoGenerator implements Poso2DtoGenerator<SaikuReport,SaikuReportDtoDec> {
	...
	@Inject
	public SaikuReport2DtoGenerator(
	...
	public SaikuReportDtoDec instantiateDto(SaikuReport poso)  {
		SaikuReportDtoDec dto = new SaikuReportDtoDec();
	...
	public SaikuReportDtoDec createDto(SaikuReport poso, DtoView here, DtoView referenced)  {
		/* create dto and set view */
		final SaikuReportDtoDec dto = new SaikuReportDtoDec();
		dto.setDtoView(here);
