...
import net.datenwerke.rs.saiku.service.saiku.entities.dtogen.Dto2SaikuReportVariantGenerator;
import net.datenwerke.rs.utils.entitycloner.annotation.TransientID;
import net.datenwerke.rs.utils.reflection.ReflectionService;

/**
 * Dto2PosoGenerator for SaikuReportVariant
 *
 * This file was automatically created by DtoAnnotationProcessor, version 0.1
 */
@GeneratedType("net.datenwerke.dtoservices.dtogenerator.DtoAnnotationProcessor")
public class Dto2SaikuReportVariantGenerator implements Dto2PosoGenerator<SaikuReportVariantDto,SaikuReportVariant> {
	...
	@Inject
	public Dto2SaikuReportVariantGenerator(
	...
	public SaikuReportVariant loadPoso(SaikuReportVariantDto dto)  {
		if(null == dto)
			return null;
		...
		SaikuReportVariant poso = entityManager.find(SaikuReportVariant.class, id);
		return poso;
	}

	public SaikuReportVariant instantiatePoso()  {
		SaikuReportVariant poso = new SaikuReportVariant();
		return poso;
	}

	public SaikuReportVariant createPoso(SaikuReportVariantDto dto)  throws ExpectedException {
		SaikuReportVariant poso = new SaikuReportVariant();
	...
	public SaikuReportVariant createUnmanagedPoso(SaikuReportVariantDto dto)  throws ExpectedException {
		SaikuReportVariant poso = new SaikuReportVariant();
	...
	public void mergePoso(SaikuReportVariantDto dto, final SaikuReportVariant poso)  throws ExpectedException {
		if(dto.isDtoProxy())
	...
	protected void mergePlainDto2Poso(SaikuReportVariantDto dto, final SaikuReportVariant poso)  throws ExpectedException {
		/*  set allowMdx */
		try{
		...
		try{
			poso.setCreatedFromPivotReport(dto.isCreatedFromPivotReport() );
		} catch(NullPointerException e){
		}
		...
		try{
			poso.setOriginalPivotReportId(dto.getOriginalPivotReportId() );
		} catch(NullPointerException e){
		}
	...
	protected void mergeProxy2Poso(SaikuReportVariantDto dto, final SaikuReportVariant poso)  throws ExpectedException {
		...
		/*  set createdFromPivotReport */
		if(dto.isCreatedFromPivotReportModified()){
			try{
				poso.setCreatedFromPivotReport(dto.isCreatedFromPivotReport() );
			} catch(NullPointerException e){
			}
		...
		/*  set originalPivotReportId */
		if(dto.isOriginalPivotReportIdModified()){
			try{
				poso.setOriginalPivotReportId(dto.getOriginalPivotReportId() );
			} catch(NullPointerException e){
			}
	...
	protected void mergePlainDto2UnmanagedPoso(SaikuReportVariantDto dto, final SaikuReportVariant poso)  throws ExpectedException {
		/*  set allowMdx */
		try{
			poso.setAllowMdx(dto.isAllowMdx() );
		} catch(NullPointerException e){
	...
	protected void mergeProxy2UnmanagedPoso(SaikuReportVariantDto dto, final SaikuReportVariant poso)  throws ExpectedException {
		/*  set allowMdx */
		if(dto.isAllowMdxModified()){
			try{
				poso.setAllowMdx(dto.isAllowMdx() );
	...
	public SaikuReportVariant loadAndMergePoso(SaikuReportVariantDto dto)  throws ExpectedException {
		SaikuReportVariant poso = loadPoso(dto);
		if(null != poso){
			mergePoso(dto, poso);
			return poso;
		}
	...
	public void postProcessCreate(SaikuReportVariantDto dto, SaikuReportVariant poso)  {

		this.postProcessor_1.posoCreated(dto, poso);
	}


	public void postProcessCreateUnmanaged(SaikuReportVariantDto dto, SaikuReportVariant poso)  {

		this.postProcessor_1.posoCreatedUnmanaged(dto, poso);
	}


	public void postProcessLoad(SaikuReportVariantDto dto, SaikuReportVariant poso)  {

		this.postProcessor_1.posoLoaded(dto, poso);
	}


	public void postProcessMerge(SaikuReportVariantDto dto, SaikuReportVariant poso)  {

		this.postProcessor_1.posoMerged(dto, poso);
	}


	public void postProcessInstantiate(SaikuReportVariant poso)  {

		this.postProcessor_1.posoInstantiated(poso);
	}


	public boolean validateKeyProperty(SaikuReportVariantDto dto, SaikuReportVariant poso)  throws ExpectedException {
