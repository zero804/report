...
import net.datenwerke.rs.dashboard.service.dashboard.entities.dtogen.DadgetNode2DtoGenerator;
import net.datenwerke.rs.utils.misc.StringEscapeUtils;
import org.apache.commons.lang.StringUtils;

/**
 * Poso2DtoGenerator for DadgetNode
 *
 * This file was automatically created by DtoAnnotationProcessor, version 0.1
 */
@GeneratedType("net.datenwerke.dtoservices.dtogenerator.DtoAnnotationProcessor")
public class DadgetNode2DtoGenerator implements Poso2DtoGenerator<DadgetNode,DadgetNodeDto> {
	...
	@Inject
	public DadgetNode2DtoGenerator(
	...
	public DadgetNodeDto instantiateDto(DadgetNode poso)  {
		DadgetNodeDto dto = new DadgetNodeDto();
	...
	public DadgetNodeDto createDto(DadgetNode poso, DtoView here, DtoView referenced)  {
		/* create dto and set view */
		final DadgetNodeDto dto = new DadgetNodeDto();
		dto.setDtoView(here);
		...
		if(here.compareTo(DtoView.NORMAL) >= 0){
			/*  set dadget */
			Object tmpDtoDadgetDtogetDadget = dtoServiceProvider.get().createDto(poso.getDadget(), here, referenced);
			dto.setDadget((DadgetDto)tmpDtoDadgetDtogetDadget);
			/* ask for a dto with higher view if generated */
			((DtoMainService)dtoServiceProvider.get()).getCreationHelper().onDtoCreation(tmpDtoDadgetDtogetDadget, poso.getDadget(), new net.datenwerke.gxtdto.server.dtomanager.CallbackOnDtoCreation(){
				public void callback(Object refDto){
					if(null != refDto)
						dto.setDadget((DadgetDto)refDto);
				}
			});
