...
package net.datenwerke.rs.scriptreport.service.scriptreport.entities.dtogen;
...
import net.datenwerke.rs.scriptreport.service.scriptreport.entities.dtogen.Dto2ScriptReportVariantGenerator;
import net.datenwerke.rs.utils.entitycloner.annotation.TransientID;
import net.datenwerke.rs.utils.reflection.ReflectionService;

/**
 * Dto2PosoGenerator for ScriptReportVariant
 *
 * This file was automatically created by DtoAnnotationProcessor, version 0.1
 */
@GeneratedType("net.datenwerke.dtoservices.dtogenerator.DtoAnnotationProcessor")
public class Dto2ScriptReportVariantGenerator implements Dto2PosoGenerator<ScriptReportVariantDto,ScriptReportVariant> {
	...
	@Inject
	public Dto2ScriptReportVariantGenerator(
	...
	public ScriptReportVariant loadPoso(ScriptReportVariantDto dto)  {
		if(null == dto)
			return null;
		...
		ScriptReportVariant poso = entityManager.find(ScriptReportVariant.class, id);
		return poso;
	}

	public ScriptReportVariant instantiatePoso()  {
		ScriptReportVariant poso = new ScriptReportVariant();
		return poso;
	}

	public ScriptReportVariant createPoso(ScriptReportVariantDto dto)  throws ExpectedException {
		ScriptReportVariant poso = new ScriptReportVariant();
	...
	public ScriptReportVariant createUnmanagedPoso(ScriptReportVariantDto dto)  throws ExpectedException {
		ScriptReportVariant poso = new ScriptReportVariant();
	...
	public void mergePoso(ScriptReportVariantDto dto, final ScriptReportVariant poso)  throws ExpectedException {
		if(dto.isDtoProxy())
	...
	protected void mergePlainDto2Poso(ScriptReportVariantDto dto, final ScriptReportVariant poso)  throws ExpectedException {
		/*  set description */
	...
	protected void mergeProxy2Poso(ScriptReportVariantDto dto, final ScriptReportVariant poso)  throws ExpectedException {
		/*  set description */
	...
	public void mergeUnmanagedPoso(ScriptReportVariantDto dto, final ScriptReportVariant poso)  throws ExpectedException {
		if(dto.isDtoProxy())
	...
	protected void mergePlainDto2UnmanagedPoso(ScriptReportVariantDto dto, final ScriptReportVariant poso)  throws ExpectedException {
		/*  set description */
		poso.setDescription(dto.getDescription() );
	...
	protected void mergeProxy2UnmanagedPoso(ScriptReportVariantDto dto, final ScriptReportVariant poso)  throws ExpectedException {
		/*  set description */
		if(dto.isDescriptionModified()){
			poso.setDescription(dto.getDescription() );
		}
	...
	public ScriptReportVariant loadAndMergePoso(ScriptReportVariantDto dto)  throws ExpectedException {
		ScriptReportVariant poso = loadPoso(dto);
		if(null != poso){
			mergePoso(dto, poso);
			return poso;
		}
	...
	public void postProcessCreate(ScriptReportVariantDto dto, ScriptReportVariant poso)  {

		this.postProcessor_1.posoCreated(dto, poso);
	}


	public void postProcessCreateUnmanaged(ScriptReportVariantDto dto, ScriptReportVariant poso)  {

		this.postProcessor_1.posoCreatedUnmanaged(dto, poso);
	}


	public void postProcessLoad(ScriptReportVariantDto dto, ScriptReportVariant poso)  {

		this.postProcessor_1.posoLoaded(dto, poso);
	}


	public void postProcessMerge(ScriptReportVariantDto dto, ScriptReportVariant poso)  {

		this.postProcessor_1.posoMerged(dto, poso);
	}


	public void postProcessInstantiate(ScriptReportVariant poso)  {

		this.postProcessor_1.posoInstantiated(poso);
	}


	public boolean validateKeyProperty(ScriptReportVariantDto dto, ScriptReportVariant poso)  throws ExpectedException {
