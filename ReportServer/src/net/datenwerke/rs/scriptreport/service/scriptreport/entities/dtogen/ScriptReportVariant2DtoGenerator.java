...
import net.datenwerke.rs.scriptreport.service.scriptreport.entities.dtogen.ScriptReportVariant2DtoGenerator;
import net.datenwerke.rs.utils.misc.StringEscapeUtils;
import org.apache.commons.lang.StringUtils;

/**
 * Poso2DtoGenerator for ScriptReportVariant
 *
 * This file was automatically created by DtoAnnotationProcessor, version 0.1
 */
@GeneratedType("net.datenwerke.dtoservices.dtogenerator.DtoAnnotationProcessor")
public class ScriptReportVariant2DtoGenerator implements Poso2DtoGenerator<ScriptReportVariant,ScriptReportVariantDtoDec> {
	...
	@Inject
	public ScriptReportVariant2DtoGenerator(
	...
	public ScriptReportVariantDtoDec instantiateDto(ScriptReportVariant poso)  {
		ScriptReportVariantDtoDec dto = new ScriptReportVariantDtoDec();
	...
	public ScriptReportVariantDtoDec createDto(ScriptReportVariant poso, DtoView here, DtoView referenced)  {
		/* create dto and set view */
		final ScriptReportVariantDtoDec dto = new ScriptReportVariantDtoDec();
		dto.setDtoView(here);
		...
		if(here.compareTo(DtoView.LIST) >= 0){
			...
			/*  set exportFormats */
			List<String> col_exportFormats = new ArrayList<String>();
			if( null != poso.getExportFormats()){
				for(String obj : poso.getExportFormats())
					col_exportFormats.add((String) obj);
				dto.setExportFormats(col_exportFormats);
			}
