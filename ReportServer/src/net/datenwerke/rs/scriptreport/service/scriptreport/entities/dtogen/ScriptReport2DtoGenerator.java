...
import net.datenwerke.rs.scriptreport.service.scriptreport.entities.dtogen.ScriptReport2DtoGenerator;
import net.datenwerke.rs.utils.misc.StringEscapeUtils;
import org.apache.commons.lang.StringUtils;

/**
 * Poso2DtoGenerator for ScriptReport
 *
 * This file was automatically created by DtoAnnotationProcessor, version 0.1
 */
@GeneratedType("net.datenwerke.dtoservices.dtogenerator.DtoAnnotationProcessor")
public class ScriptReport2DtoGenerator implements Poso2DtoGenerator<ScriptReport,ScriptReportDtoDec> {
	...
	@Inject
	public ScriptReport2DtoGenerator(
	...
	public ScriptReportDtoDec instantiateDto(ScriptReport poso)  {
		ScriptReportDtoDec dto = new ScriptReportDtoDec();
	...
	public ScriptReportDtoDec createDto(ScriptReport poso, DtoView here, DtoView referenced)  {
		/* create dto and set view */
		final ScriptReportDtoDec dto = new ScriptReportDtoDec();
		dto.setDtoView(here);
