...
public class ScriptParameterConfigurator extends ParameterConfiguratorImpl<ScriptParameterDefinitionDto, ScriptParameterInstanceDto> {
	...
	@Override
	public Widget doGetEditComponentForInstance(final ScriptParameterInstanceDto instance, Collection<ParameterInstanceDto> relevantInstances, final ScriptParameterDefinitionDto definition, boolean initial, int labelWidth, String executeReportToken) {
