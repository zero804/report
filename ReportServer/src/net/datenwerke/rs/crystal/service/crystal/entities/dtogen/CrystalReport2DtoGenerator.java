...
import net.datenwerke.rs.crystal.service.crystal.entities.dtogen.CrystalReport2DtoGenerator;
import net.datenwerke.rs.utils.misc.StringEscapeUtils;
import org.apache.commons.lang.StringUtils;

/**
 * Poso2DtoGenerator for CrystalReport
 *
 * This file was automatically created by DtoAnnotationProcessor, version 0.1
 */
@GeneratedType("net.datenwerke.dtoservices.dtogenerator.DtoAnnotationProcessor")
public class CrystalReport2DtoGenerator implements Poso2DtoGenerator<CrystalReport,CrystalReportDtoDec> {
	...
	@Inject
	public CrystalReport2DtoGenerator(
	...
	public CrystalReportDtoDec instantiateDto(CrystalReport poso)  {
		CrystalReportDtoDec dto = new CrystalReportDtoDec();
	...
	public CrystalReportDtoDec createDto(CrystalReport poso, DtoView here, DtoView referenced)  {
		/* create dto and set view */
		final CrystalReportDtoDec dto = new CrystalReportDtoDec();
		dto.setDtoView(here);
