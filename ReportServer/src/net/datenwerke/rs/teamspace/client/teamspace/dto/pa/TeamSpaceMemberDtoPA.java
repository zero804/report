...
@CorrespondingPoso(net.datenwerke.rs.teamspace.service.teamspace.entities.TeamSpaceMember.class)
public interface TeamSpaceMemberDtoPA extends PropertyAccess<TeamSpaceMemberDto> {


	public static final TeamSpaceMemberDtoPA INSTANCE = GWT.create(TeamSpaceMemberDtoPA.class);
