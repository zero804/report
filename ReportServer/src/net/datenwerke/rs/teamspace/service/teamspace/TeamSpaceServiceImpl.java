...
public class TeamSpaceServiceImpl implements TeamSpaceService {
	...
	public List<TeamSpaceAppDefinition> getInstalledApps() {
		...
		List<TeamSpaceAppDefinitionProviderHook> appProviders = hookHandler.getHookers(TeamSpaceAppDefinitionProviderHook.class);
	...
	public boolean isGlobalTsAdmin() {
		return securityService.checkRights(TeamSpaceSecurityTarget.class, TeamSpaceSecuree.class, TeamSpaceAdministrator.class);
	}
	
	@Override
	public boolean isGlobalTsAdmin(User user) {
		return securityService.checkRights(user, TeamSpaceSecurityTarget.class, TeamSpaceSecuree.class, TeamSpaceAdministrator.class);
	}
