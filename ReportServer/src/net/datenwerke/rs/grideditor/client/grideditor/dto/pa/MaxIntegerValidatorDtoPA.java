...
public interface MaxIntegerValidatorDtoPA extends ValidatorDtoPA {


	public static final MaxIntegerValidatorDtoPA INSTANCE = GWT.create(MaxIntegerValidatorDtoPA.class);


	/* Properties */
	public ValueProvider<MaxIntegerValidatorDto,Integer> number();
