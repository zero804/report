...
import net.datenwerke.rs.grideditor.service.grideditor.entities.dtogen.GridEditorReportVariant2DtoGenerator;
import net.datenwerke.rs.utils.misc.StringEscapeUtils;
import org.apache.commons.lang.StringUtils;

/**
 * Poso2DtoGenerator for GridEditorReportVariant
 *
 * This file was automatically created by DtoAnnotationProcessor, version 0.1
 */
@GeneratedType("net.datenwerke.dtoservices.dtogenerator.DtoAnnotationProcessor")
public class GridEditorReportVariant2DtoGenerator implements Poso2DtoGenerator<GridEditorReportVariant,GridEditorReportVariantDtoDec> {
	...
	@Inject
	public GridEditorReportVariant2DtoGenerator(
	...
	public GridEditorReportVariantDtoDec instantiateDto(GridEditorReportVariant poso)  {
		GridEditorReportVariantDtoDec dto = new GridEditorReportVariantDtoDec();
	...
	public GridEditorReportVariantDtoDec createDto(GridEditorReportVariant poso, DtoView here, DtoView referenced)  {
		/* create dto and set view */
		final GridEditorReportVariantDtoDec dto = new GridEditorReportVariantDtoDec();
		dto.setDtoView(here);
