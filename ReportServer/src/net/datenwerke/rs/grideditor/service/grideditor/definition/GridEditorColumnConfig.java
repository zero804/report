...
public class GridEditorColumnConfig {
	...
	public void setForeignKey(String tableName, String fkColumn, String displayExpression, String displayName){
		setForeignKey(
			new GridEditorForeignKeyRelationship(tableName, fkColumn, displayExpression, displayName)
		);
	}
	
	public void setForeignKey(String tableName, String fkColumn, String displayExpression, GridEditorColumnConfig fkConfig){
		setForeignKey(
			new GridEditorForeignKeyRelationship(tableName, fkColumn, displayExpression, fkConfig)
		);
	}
