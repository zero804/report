...
import net.datenwerke.security.client.security.dto.pa.ReadDtoPA;
import net.datenwerke.security.client.security.dto.posomap.ReadDto2PosoMap;
...
public class ReadDto extends RsDto implements RightDto {
	...
	public static final String PROPERTY_ABBREVIATION = "dpi-read-abbreviation";

	private transient static PropertyAccessor<ReadDto, String> abbreviation_pa = new PropertyAccessor<ReadDto, String>() {
		@Override
		public void setValue(ReadDto container, String object) {
			container.setAbbreviation(object);
		}

		@Override
		public String getValue(ReadDto container) {
		...
		@Override
		public void setModified(ReadDto container, boolean modified) {
			container.abbreviation_m = modified;
		}

		@Override
		public boolean isModified(ReadDto container) {
	...
	public static final String PROPERTY_BIT_FIELD = "dpi-read-bitfield";

	private transient static PropertyAccessor<ReadDto, Long> bitField_pa = new PropertyAccessor<ReadDto, Long>() {
		@Override
		public void setValue(ReadDto container, Long object) {
			container.setBitField(object);
		}

		@Override
		public Long getValue(ReadDto container) {
	...
	public static final String PROPERTY_DESCRIPTION = "dpi-read-description";

	private transient static PropertyAccessor<ReadDto, String> description_pa = new PropertyAccessor<ReadDto, String>() {
		@Override
		public void setValue(ReadDto container, String object) {
	...
	public void setAbbreviation(String abbreviation)  {
		...
		this.fireObjectChangedEvent(ReadDtoPA.INSTANCE.abbreviation(), oldValue);
	}
	...
	public static PropertyAccessor<ReadDto, String> getAbbreviationPropertyAccessor()  {
	...
	public void setBitField(long bitField)  {
		...
		this.fireObjectChangedEvent(ReadDtoPA.INSTANCE.bitField(), oldValue);
	}
	...
	public static PropertyAccessor<ReadDto, Long> getBitFieldPropertyAccessor()  {
		return bitField_pa;
	}
	...
	public void setDescription(String description)  {
		...
		this.fireObjectChangedEvent(ReadDtoPA.INSTANCE.description(), oldValue);
	}
	...
	public static PropertyAccessor<ReadDto, String> getDescriptionPropertyAccessor()  {
	...
	public static Dto2PosoMapper newPosoMapper()  {
		return new ReadDto2PosoMap();
	}

	public ReadDtoPA instantiatePropertyAccess()  {
		return GWT.create(ReadDtoPA.class);
	}
