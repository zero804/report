...
import net.datenwerke.security.client.security.dto.pa.DeleteDtoPA;
import net.datenwerke.security.client.security.dto.posomap.DeleteDto2PosoMap;
...
public class DeleteDto extends RsDto implements RightDto {
	...
	public static final String PROPERTY_ABBREVIATION = "dpi-delete-abbreviation";

	private transient static PropertyAccessor<DeleteDto, String> abbreviation_pa = new PropertyAccessor<DeleteDto, String>() {
		@Override
		public void setValue(DeleteDto container, String object) {
			container.setAbbreviation(object);
		}

		@Override
		public String getValue(DeleteDto container) {
		...
		@Override
		public void setModified(DeleteDto container, boolean modified) {
			container.abbreviation_m = modified;
		}

		@Override
		public boolean isModified(DeleteDto container) {
	...
	public static final String PROPERTY_BIT_FIELD = "dpi-delete-bitfield";

	private transient static PropertyAccessor<DeleteDto, Long> bitField_pa = new PropertyAccessor<DeleteDto, Long>() {
		@Override
		public void setValue(DeleteDto container, Long object) {
			container.setBitField(object);
		}

		@Override
		public Long getValue(DeleteDto container) {
	...
	public static final String PROPERTY_DESCRIPTION = "dpi-delete-description";

	private transient static PropertyAccessor<DeleteDto, String> description_pa = new PropertyAccessor<DeleteDto, String>() {
		@Override
		public void setValue(DeleteDto container, String object) {
	...
	public void setAbbreviation(String abbreviation)  {
		...
		this.fireObjectChangedEvent(DeleteDtoPA.INSTANCE.abbreviation(), oldValue);
	}
	...
	public static PropertyAccessor<DeleteDto, String> getAbbreviationPropertyAccessor()  {
	...
	public void setBitField(long bitField)  {
		...
		this.fireObjectChangedEvent(DeleteDtoPA.INSTANCE.bitField(), oldValue);
	}
	...
	public static PropertyAccessor<DeleteDto, Long> getBitFieldPropertyAccessor()  {
		return bitField_pa;
	}
	...
	public void setDescription(String description)  {
		...
		this.fireObjectChangedEvent(DeleteDtoPA.INSTANCE.description(), oldValue);
	}
	...
	public static PropertyAccessor<DeleteDto, String> getDescriptionPropertyAccessor()  {
	...
	public static Dto2PosoMapper newPosoMapper()  {
		return new DeleteDto2PosoMap();
	}

	public DeleteDtoPA instantiatePropertyAccess()  {
		return GWT.create(DeleteDtoPA.class);
	}
