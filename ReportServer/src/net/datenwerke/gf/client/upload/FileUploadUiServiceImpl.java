...
public class FileUploadUiServiceImpl implements FileUploadUiService {
	...
	public Component addCombinedUploadField(final UploadProperties properties){
	    ...
	    /* get layout */
		HtmlUploadFieldContainer container = new HtmlUploadFieldContainer(
    		tpl.getTemplate(UploadMessages.INSTANCE)
    	);
	...
	public void handleUploadReturn(FormPanel form, final UploadHandler handler) {
		form.addSubmitCompleteHandler(new SubmitCompleteHandler() {
			...
			public void onSubmitComplete(SubmitCompleteEvent event) {
				...
				DetailErrorDialog dialog = new DetailErrorDialog(BaseMessages.INSTANCE.error(), BaseMessages.INSTANCE.uploadErrorDetail(detail), event.getResults());
