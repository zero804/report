...
public class TreeGridSelectionPopup<G> extends Grid<G> {
	...
	public TreeGridSelectionPopup(Map<ValueProvider<G, String>, String> displayProperties, int columnWidth, ListStore<G> selectedStore, UITree tree, Class<? extends RsDto>... types){
