...
public class DynamicListProvider extends BaseListProvider {
	...
	private Widget createFormField_multi_popup() {
		/* create grid */
		SimpleGridSelectionPopup simpleGridSelectionPopup = new SimpleGridSelectionPopup(getPropertyLabel(), getStoreKey(), new ListStore(getStore().getKeyProvider()), getStore()){
			@Override
