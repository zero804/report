...
public class ExImportHelperService {
	...
	/**
	 * Adds an <i>entityId</i> to the attribute <b>xml:id</b> in the given {@link Element}
	 * 
	 * @param el The {@link Element} holding the <b>xml:id</b> attribute
	...
	public String getIdAttribute(Element el){
		/* has to be xml:id */
		return null != el.getAttribute("id", XMLConstants.XML_NS_URI) ? el.getAttribute("id", XMLConstants.XML_NS_URI).getValue() : null;
	}

	/**
	 * Sets the <b>IS_NULL_ATTRIBUTE</b> attribute of the given {@link Element} to <b>XML_TRUE</b>
	 * 
	 * @param el The {@link Element} to set the attribute on
	 * @throws XMLStreamException 
	 */
	...
	/**
	 * Sets the <b>VALUE_ATTRIBUTE</b> attribute of the given {@link Element} to the given <i>value</i>
	 * 
	 * @param xsw The {@link Element} to set the attribute on
	...
	/**
	 * Sets the <b>TYPE_ATTRIBUTE</b> attribute of the given {@link Element} to the given <i>type</i>
	 * 
	 * @param el The {@link Element} to set the attribute on
	...
	/**
	 * Sets the <b>IS_COLLECTION_ATTRIBUTE</b> attribute of the given {@link Element} to <b>XML_TRUE</b>
	 * and the <b>PROPERTY_TYPE</b> to <i>propertyType</i>.getName()
	 * 
	 * @param el The {@link Element} to set the attributes on
	 ...
	 * @param type The type to set <b>TYPE_ATTRIBUTE</b> to
	 ...
	 * @throws XMLStreamException 
	 */
	public void setReferenceAttributes(XMLStreamWriter xsw, String id, Exporter exporter, boolean optional) throws XMLStreamException {
	 ...
	 * @throws XMLStreamException 
	 */
	public void setReferenceAttributes(XMLStreamWriter xsw, String id, Class<?> exporterType, boolean optional) throws XMLStreamException {
	...
	/**
	 * Sets the <b>EXPORTER_TYPE</b> attribute of the given {@link Element}
	 * 
	 * @param el The {@link Element} to set the attribute on
	 * @param exporter The {@link Exporter} to set the <b>EXPORTER_TYPE</b> attribute to
	 * @throws XMLStreamException 
	 */
	...
	/**
	 * Sets the {@link Element}s <b>EXPORTER_TYPE</b> and <b>IS_ENCLOSED_ATTRIBUTE</b> attributes
	 * 
	 * @param enclosedEl The {@link Element} to set the attributes on
