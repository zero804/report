...
import net.datenwerke.scheduler.service.scheduler.triggers.complex.config.dtogen.Dto2MonthlyNthDayConfigGenerator;
...
/**
 * Dto2PosoGenerator for MonthlyNthDayConfig
 *
 * This file was automatically created by DtoAnnotationProcessor, version 0.1
 */
@GeneratedType("net.datenwerke.dtoservices.dtogenerator.DtoAnnotationProcessor")
public class Dto2MonthlyNthDayConfigGenerator implements Dto2PosoGenerator<MonthlyNthDayConfigDto,MonthlyNthDayConfig> {
	...
	@Inject
	public Dto2MonthlyNthDayConfigGenerator(
	...
	public MonthlyNthDayConfig loadPoso(MonthlyNthDayConfigDto dto)  {
		if(null == dto)
			return null;
		...
		MonthlyNthDayConfig poso = entityManager.find(MonthlyNthDayConfig.class, id);
		return poso;
	}

	public MonthlyNthDayConfig instantiatePoso()  {
		MonthlyNthDayConfig poso = new MonthlyNthDayConfig();
		return poso;
	}

	public MonthlyNthDayConfig createPoso(MonthlyNthDayConfigDto dto)  throws ExpectedException {
		MonthlyNthDayConfig poso = new MonthlyNthDayConfig();
	...
	public MonthlyNthDayConfig createUnmanagedPoso(MonthlyNthDayConfigDto dto)  throws ExpectedException {
		MonthlyNthDayConfig poso = new MonthlyNthDayConfig();
	...
	public void mergePoso(MonthlyNthDayConfigDto dto, final MonthlyNthDayConfig poso)  throws ExpectedException {
		if(dto.isDtoProxy())
	...
	protected void mergePlainDto2Poso(MonthlyNthDayConfigDto dto, final MonthlyNthDayConfig poso)  throws ExpectedException {
		/*  set atTime */
		...
		/*  set dayInMonth */
		poso.setDayInMonth(dto.getDayInMonth() );
	...
	protected void mergeProxy2Poso(MonthlyNthDayConfigDto dto, final MonthlyNthDayConfig poso)  throws ExpectedException {
		/*  set atTime */
	...
	public void mergeUnmanagedPoso(MonthlyNthDayConfigDto dto, final MonthlyNthDayConfig poso)  throws ExpectedException {
		if(dto.isDtoProxy())
	...
	protected void mergePlainDto2UnmanagedPoso(MonthlyNthDayConfigDto dto, final MonthlyNthDayConfig poso)  throws ExpectedException {
		/*  set atTime */
		TimeDto tmpDto_atTime = dto.getAtTime();
		poso.setAtTime((Time)dtoServiceProvider.get().createPoso(tmpDto_atTime));
	...
	protected void mergeProxy2UnmanagedPoso(MonthlyNthDayConfigDto dto, final MonthlyNthDayConfig poso)  throws ExpectedException {
		/*  set atTime */
		if(dto.isAtTimeModified()){
			TimeDto tmpDto_atTime = dto.getAtTime();
			poso.setAtTime((Time)dtoServiceProvider.get().createPoso(tmpDto_atTime));
	...
	public MonthlyNthDayConfig loadAndMergePoso(MonthlyNthDayConfigDto dto)  throws ExpectedException {
		MonthlyNthDayConfig poso = loadPoso(dto);
		if(null != poso){
			mergePoso(dto, poso);
			return poso;
		}
	...
	public void postProcessCreate(MonthlyNthDayConfigDto dto, MonthlyNthDayConfig poso)  {
	}


	public void postProcessCreateUnmanaged(MonthlyNthDayConfigDto dto, MonthlyNthDayConfig poso)  {
	}


	public void postProcessLoad(MonthlyNthDayConfigDto dto, MonthlyNthDayConfig poso)  {
	}


	public void postProcessMerge(MonthlyNthDayConfigDto dto, MonthlyNthDayConfig poso)  {
	}


	public void postProcessInstantiate(MonthlyNthDayConfig poso)  {
	}
