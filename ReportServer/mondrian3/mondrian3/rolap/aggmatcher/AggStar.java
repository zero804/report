...
import mondrian3.olap.MondrianDef.AggLevel;
import mondrian3.recorder.MessageRecorder;
import mondrian3.resource.MondrianResource;
import mondrian3.rolap.*;
import mondrian3.rolap.aggmatcher.JdbcSchema.Table.Column.Usage;
import mondrian3.rolap.aggmatcher.JdbcSchema.UsageType;
...
public class AggStar {
    ...
    public abstract class Table {
        ...
        public class JoinCondition {
            ...
            public void print(final PrintWriter pw, final String prefix) {
                ...
                if (left instanceof MondrianDef.Column) {
                    ...
                    mondrian3.rolap.RolapStar.Column col =
        ...
        /**
         * Converts a {@link mondrian3.rolap.RolapStar.Table} into a
