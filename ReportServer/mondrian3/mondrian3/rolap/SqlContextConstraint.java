...
import mondrian3.rolap.RestrictedMemberReader.MultiCardinalityDefaultMember;
    ...
    implements MemberChildrenConstraint, TupleConstraint
{
    ...
    * methods {@link mondrian3.rolap.sql.MemberChildrenConstraint#addMemberConstraint(mondrian3.rolap.sql.SqlQuery, mondrian3.rolap.RolapCube, mondrian3.rolap.aggmatcher.AggStar, RolapMember)} and
    * {@link mondrian3.rolap.sql.MemberChildrenConstraint#addMemberConstraint(mondrian3.rolap.sql.SqlQuery, mondrian3.rolap.RolapCube, mondrian3.rolap.aggmatcher.AggStar, java.util.List)} will
