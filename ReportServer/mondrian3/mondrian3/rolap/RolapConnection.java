...
import mondrian3.parser.MdxParserValidator;
import mondrian3.resource.MondrianResource;
import mondrian3.server.*;
import mondrian3.spi.*;
import mondrian3.spi.impl.JndiDataSourceResolver;
 ...
 * {@link DriverManager#getConnection(String, mondrian3.spi.CatalogLocator)}.
...
public class RolapConnection extends ConnectionBase {
    ...
    /**
     * Returns the instance of the {@link mondrian3.spi.DataSourceResolver}
     * plugin.
     *
     ...
     * {@link mondrian3.olap.Util.PropertyList connectInfo}.
     *
     ...
     *     the property file
     *
     * @deprecated Use {@link #execute(mondrian3.server.Execution)}; this method
