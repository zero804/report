...
/**
 * Utility methods for classes in the <code>mondrian3.rolap</code> package.
 *
 * @author jhyde
 * @since 22 December, 2001
 */
public class RolapUtil {
    public static final Logger MDX_LOGGER = Logger.getLogger("mondrian3.mdx");
    public static final Logger SQL_LOGGER = Logger.getLogger("mondrian3.sql");
    public static final Logger MONITOR_LOGGER =
        Logger.getLogger("mondrian3.server.monitor");
    public static final Logger PROFILE_LOGGER =
        Logger.getLogger("mondrian3.profile");
     ...
     * {@link #setHook(mondrian3.rolap.RolapUtil.ExecuteQueryHook)} are
     ...
     * {@link mondrian3.calc.Calc#dependsOn(Hierarchy)} are accurate.
     */
