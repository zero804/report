...
import mondrian3.olap.fun.VisualTotalsFunDef;
    ...
    implements RolapMember
{
     ...
     * {@link mondrian3.olap.CacheControl#createMoveCommand}.
     *
     ...
     * {@link mondrian3.olap.fun.FunUtil#compareHierarchically}.
     *
     ...
     * {@link mondrian3.olap.MondrianProperties#PropertyValueMapFactoryClass}
     * is not set.
     */
        ...
        implements PropertyValueMapFactory
    {
         ...
         * {@link mondrian3.olap.Member}</p> have additional properties
         * that aren't explicitly declared.  The most common offenders
         * are the (@link mondrian3.olap.Measure} implementations, which
     ...
     * {@link mondrian3.olap.MondrianProperties#PropertyValueMapFactoryClass}
     * in mondrian3.properties.  If unset, it defaults to
