...
import mondrian3.olap.Role.RollupPolicy;
...
public class CrossJoinArgFactory {
     ...
     *
     * @return an {@link mondrian3.rolap.sql.CrossJoinArg} instance describing the enumeration,
     ...
     *
     * @return an {@link mondrian3.rolap.sql.CrossJoinArg} instance describing the member.children
     ...
     *
     * @return an {@link mondrian3.rolap.sql.CrossJoinArg} instance describing the Level.members
     *         function, or null if <code>fun</code> represents something else.
     */
     ...
     *
     * @return an {@link mondrian3.rolap.sql.CrossJoinArg} instance describing the Descendants
     *         function, or null if <code>fun</code> represents something else.
     */
        ...
        boolean exclude)
    {
        ...
        if (!(currentMemberArgType
            instanceof mondrian3.olap.type.DimensionType
