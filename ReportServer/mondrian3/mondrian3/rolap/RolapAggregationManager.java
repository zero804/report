...
import mondrian3.olap.fun.VisualTotalsFunDef.VisualTotalMember;
import mondrian3.resource.MondrianResource;
import mondrian3.rolap.agg.*;

import java.util.*;

/**
 * <code>RolapAggregationManager</code> manages all
 * {@link mondrian3.rolap.agg.Segment}s in the system.
 *
 ...
 * in the derived class, {@link mondrian3.rolap.agg.AggregationManager}.
 *
 * @author jhyde
...
public abstract class RolapAggregationManager {
    ...
    /**
     * Returns a {@link mondrian3.rolap.CellReader} which reads cells from cache.
     */
