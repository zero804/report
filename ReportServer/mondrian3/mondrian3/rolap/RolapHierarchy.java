...
import mondrian3.olap.Role.HierarchyAccess;
...
import mondrian3.util.UnionIterator;
...
public class RolapHierarchy extends HierarchyBase {
    ...
    MemberReader createMemberReader(Role role) {
        ...
        case CUSTOM:
            ...
            case PARTIAL:
                Type memberType1 =
                    new mondrian3.olap.type.MemberType(
                        getDimension(),
                        this,
                        null,
                        null);
     ...
     * {@link mondrian3.olap.MondrianDef.Closure} element
     ...
     * As part of {@link mondrian3.util.Bug#BugSegregateRolapCubeMemberFixed},
     * maybe make {@link mondrian3.rolap.RolapCubeMember} an interface.
     *
     * @see mondrian3.olap.Role.RollupPolicy
     */
