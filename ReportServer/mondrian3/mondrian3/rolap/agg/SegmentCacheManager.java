 ...
 * by a {@link mondrian3.spi.SegmentCache}.
 *
 * <p>Segment states</p>
 *
 * <table>
 ...
 *
 * <p>3. Delete {@link mondrian3.rolap.RolapStar#lookupOrCreateAggregation}
 * and {@link mondrian3.rolap.RolapStar#lookupSegment}
 * and {@link mondrian3.rolap.RolapStar}.lookupAggregationShared
 ...
 *
 * <p>1. {@link mondrian3.rolap.RolapStar#getCellFromCache} moved from
 ...
 * mondrian3.rolap.agg.enableCacheHitCounters.</p>
 *
 ...
 * mondrian3.spi. Leave behind dependencies on mondrian3.rolap.agg. In particular,
 ...
 *
 * <p>8. Longer term. Move {@link mondrian3.rolap.RolapStar.Bar}.segmentRefs to
 * {@link mondrian3.server.Execution}. Would it still be thread-local?</p>
 *
 * <p>10. Call
 * {@link mondrian3.spi.DataSourceChangeListener#isAggregationChanged}.
 ...
 * {@link mondrian3.rolap.agg.SegmentBuilder.SegmentConverter} is a hack that
 ...
 * {@link mondrian3.rolap.agg.SegmentCacheManager#peek}.</p>
 *
 ...
 * copying.</p>
 *
 * <p>21. Obsolete {@link mondrian3.util.CombiningGenerator}.</p>
 *
 * <p>22. {@link SegmentHeader#constrain(mondrian3.spi.SegmentColumn[])} is
...
public class SegmentCacheManager {
    ...
    public final ExecutorService cacheExecutor =
        Util.getExecutorService(
            ...
            0, 1,
            "mondrian3.rolap.agg.SegmentCacheManager$cacheExecutor",
    ...
    public final ExecutorService sqlExecutor =
        Util.getExecutorService(
            ...
            0, 1,
            "mondrian3.rolap.agg.SegmentCacheManager$sqlExecutor",
            new RejectedExecutionHandler() {
                public void rejectedExecution(
                    Runnable r,
                    ThreadPoolExecutor executor)
    ...
    public SegmentCacheManager(MondrianServer server) {
        ...
        ACTOR = new Actor();
        thread = new Thread(
            ACTOR, "mondrian3.rolap.agg.SegmentCacheManager$ACTOR");
    ...
    private static abstract class Event implements Message {
         ...
         * {@link mondrian3.server.monitor.Visitor}.
         *
    ...
    /**
     * Copy-pasted from {@link mondrian3.server.monitor.Monitor}. Consider
