...
import mondrian3.rolap.SqlStatement.Type;
...
public class AggregationManager extends RolapAggregationManager {
     ...
     *   Use {@link mondrian3.olap.MondrianServer#getAggregationManager()}.
     *   To get a server, call
     *   {@link mondrian3.olap.MondrianServer#forConnection(mondrian3.olap.Connection)},
...
*/
    ...
    /**
     * Implementation of {@link mondrian3.rolap.RolapAggregationManager.PinSet}
