...
import mondrian3.calc.ParameterSlot;
 ...
 * {@link mondrian3.olap.Evaluator#setContext(mondrian3.olap.Member)}) creates, at
...
public class RolapEvaluator implements Evaluator {
    ...
    /**
     * More specific version of {@link #getContext(mondrian3.olap.Hierarchy)},
     * for internal code.
     *
     ...
     * @throws mondrian3.olap.fun.MondrianEvaluationException if there is a loop
     */
