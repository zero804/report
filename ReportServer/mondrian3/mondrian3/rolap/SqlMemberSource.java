...
*/
     ...
     *
     * <p>If
     * {@link mondrian3.olap.MondrianProperties#SqlMemberSourceValuePoolFactoryClass}
    ...
    private static class RolapParentChildMember extends RolapMemberBase {
         ...
         * @see mondrian3.olap.Member#getDepth()
         */
        public int getDepth() {
            return depth;
        }
    ...
    /**
     * Default {@link mondrian3.rolap.SqlMemberSource.ValuePoolFactory}
     ...
     * {@link mondrian3.rolap.SqlMemberSource.NullValuePoolFactory}. </p>
     */
