 ...
 * <dl>
 *
 * <dt>Obsolete {@link mondrian3.olap.Id.Segment}</dt>
 * <dd>Replace it by {@link org.olap4j.mdx.IdentifierSegment}. Likewise
 * {@link mondrian3.olap.Id.Quoting} with {@link org.olap4j.mdx.Quoting}.
...
public class Bug {
     ...
     * {@link mondrian3.olap.MondrianProperties#SsasCompatibleNaming},
     ...
     * {@link mondrian3.spi.Dialect.DatabaseProduct#LUCIDDB} and we wish to
     * avoid slow tests.
     *
     ...
     * {@code mondrian3.test.PerforceTest} logger set at
    ...
    public static boolean avoidSlowTestOnLucidDB(Dialect dialect) {
        return
            ...
            && !Logger.getLogger("mondrian3.test.PerformanceTest")
                .isDebugEnabled();
    }
}
