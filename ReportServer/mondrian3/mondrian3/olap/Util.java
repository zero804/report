...
import mondrian3.olap.fun.Resolver;
...
/**
 * Utility functions used throughout mondrian3. All methods are static.
 *
 * @author jhyde
 * @since 6 August, 2001
 */
public class Util extends XOMUtil {
     ...
     * things are available via {@link mondrian3.util.UtilCompatible}.
    ...
    static {
        ...
        if (PreJdk15 || Retrowoven) {
            className = "mondrian3.util.UtilCompatibleJdk14";
        } else if (PreJdk16) {
            className = "mondrian3.util.UtilCompatibleJdk15";
        } else {
            className = "mondrian3.util.UtilCompatibleJdk16";
        }
     ...
     * In this case, the result will be a {@link mondrian3.mdx.ResolvedFunCall}.
     *
     ...
     * a look at the <code>mondrian3.olap.UtilTestCase</code> test case.
     */
     ...
     *
     * @deprecated Use {@link mondrian3.server.monitor.Monitor#getServer()} and
     *  {@link mondrian3.server.monitor.ServerInfo#sqlStatementExecuteNanos};
     ...
     *
     * @see mondrian3.olap.Util.Flat3List
     * @param <T>
     */
     ...
     * <p>The list is created via {@link Util#flatList(Object[])}.
     *
     * @see mondrian3.olap.Util.Flat2List
     * @param <T>
     */
     ...
     *
     * @see mondrian3.olap.Util#getMemoryInfo()
     */
