 ...
 * <code>mondrian3.properties</code> file. Although it is possible to retrieve
...
public class MondrianProperties extends MondrianPropertiesBase {
     ...
     * plus the contents of "mondrian3.properties" if it
     * exists. A singleton.
     */
    ...
    public transient final StringProperty AggregateRuleTag =
        new StringProperty(
            this, "mondrian3.rolap.aggregates.rule.tag", "default");
     ...
     * mondrian3.rolap.aggmatcher package in mondrian3.jar.</p>
     *
     * <p>Normally, this property is not set by a user.</p>
     */
    public transient final StringProperty AggregateRules =
        new StringProperty(
            this, "mondrian3.rolap.aggregates.rules", "/DefaultRules.xml");
    ...
    public transient final StringProperty AlertNativeEvaluationUnsupported =
        new StringProperty(
            this, "mondrian3.native.unsupported.alert", "OFF");
    ...
    public transient final BooleanProperty CaseSensitive =
        new BooleanProperty(
            this, "mondrian3.olap.case.sensitive", false);

    /**
     * Property that contains the URL of the catalog to be used by
     * {@link mondrian3.tui.CmdRunner} and XML/A Test.
     */
    public transient final StringProperty CatalogURL =
        new StringProperty(
            this, "mondrian3.catalogURL", null);
    ...
    public transient final IntegerProperty CellBatchSize =
        new IntegerProperty(
            this, "mondrian3.rolap.cellBatchSize", -1);
    ...
    public transient final BooleanProperty ChooseAggregateByVolume =
        new BooleanProperty(
            this, "mondrian3.rolap.aggregates.ChooseByVolume", false);
    ...
    public transient final BooleanProperty CompareSiblingsByOrderKey =
        new BooleanProperty(
            this, "mondrian3.rolap.compareSiblingsByOrderKey", false);
    ...
    public transient final IntegerProperty CrossJoinOptimizerSize =
        new IntegerProperty(
            this, "mondrian3.olap.fun.crossjoin.optimizer.size", 0);
     ...
     * {@link mondrian3.spi.DataSourceResolver} interface. If not specified,
     * the default implementation uses JNDI to perform resolution.</p>
     *
     * <p>Example:</p>
     * <blockquote><code>mondrian3.spi.dataSourceResolverClass=mondrian3.spi.impl.JndiDataSourceResolver</code></blockquote>
     */
    public transient final StringProperty DataSourceResolverClass =
        new StringProperty(
            this, "mondrian3.spi.dataSourceResolverClass", null);
    ...
    public transient final BooleanProperty DisableCaching =
        new BooleanProperty(
            this, "mondrian3.rolap.star.disableCaching", false);
    ...
    public transient final BooleanProperty DisableLocalSegmentCache =
        new BooleanProperty(
            this, "mondrian3.rolap.star.disableLocalSegmentCache", false);
    ...
    public transient final BooleanProperty EnableCacheHitCounters =
        new BooleanProperty(
            this, "mondrian3.rolap.agg.enableCacheHitCounters", false);
    ...
    public transient final BooleanProperty EnableDrillThrough =
        new BooleanProperty(
            this, "mondrian3.drillthrough.enable", true);
    ...
    public transient final BooleanProperty EnableExpCache =
        new BooleanProperty(
            this, "mondrian3.expCache.enable", true);
     ...
     * {@link mondrian3.spi.Dialect#supportsGroupingSets}).</p>
     */
    public transient final BooleanProperty EnableGroupingSets =
        new BooleanProperty(
            this, "mondrian3.rolap.groupingsets.enable", false);
    ...
    public transient final BooleanProperty EnableInMemoryRollup =
        new BooleanProperty(
            this, "mondrian3.rolap.EnableInMemoryRollup", true);
    ...
    public transient final BooleanProperty EnableNativeCrossJoin =
        new BooleanProperty(
            this, "mondrian3.native.crossjoin.enable", true);
    ...
    public transient final BooleanProperty EnableNativeFilter =
        new BooleanProperty(
            this, "mondrian3.native.filter.enable", true);
    ...
    public transient final BooleanProperty EnableNativeNonEmpty =
        new BooleanProperty(
            this, "mondrian3.native.nonempty.enable", true);
    ...
    public transient final BooleanProperty EnableNativeTopCount =
        new BooleanProperty(
            this, "mondrian3.native.topcount.enable", true);
    ...
    public transient final BooleanProperty EnableNonEmptyOnAllAxis =
        new BooleanProperty(
            this, "mondrian3.rolap.nonempty", false);
     ...
     * the member cache control aspects of {@link mondrian3.olap.CacheControl},
    ...
    public transient final BooleanProperty EnableRolapCubeMemberCache =
        new BooleanProperty(
            this, "mondrian3.rolap.EnableRolapCubeMemberCache", true);
    ...
    public transient final BooleanProperty EnableTotalCount =
        new BooleanProperty(
            this, "mondrian3.xmla.drillthroughTotalCount.enable", true);
    ...
    public transient final BooleanProperty EnableTriggers =
        new BooleanProperty(
            this, "mondrian3.olap.triggers.enable", true);
    ...
    public transient final IntegerProperty ExecutionHistorySize =
        new IntegerProperty(
            this, "mondrian3.server.monitor.executionHistorySize", 1000);
     ...
     *
     * <blockquote><code>mondrian3.calc.ExpCompiler.class=mondrian3.olap.fun.ResultStyleCompiler</code></blockquote>
     */
    public transient final StringProperty ExpCompilerClass =
        new StringProperty(
            this, "mondrian3.calc.ExpCompiler.class", null);
    ...
    public transient final BooleanProperty ExpandNonNative =
        new BooleanProperty(
            this, "mondrian3.native.ExpandNonNative", false);
    ...
    public transient final BooleanProperty FilterChildlessSnowflakeMembers =
        new BooleanProperty(
            this, "mondrian3.rolap.FilterChildlessSnowflakeMembers", true);
     ...
     * mondrian3.foodmart.jdbcURL and mondrian3.jdbcDrivers properties, by
     ...
     * <blockquote><code>
     * mondrian3.foodmart.jdbcURL=jdbc:derby:demo/derby/foodmart<br></br>
     * mondrian3.foodmart.jdbcUser=sa<br></br>
     * mondrian3.foodmart.jdbcPassword=sa<br></br>
     * mondrian3.jdbcDrivers=org.apache.derby.jdbc.EmbeddedDriver<br></br>
     * driver.classpath=testlib/derby.jar</code></blockquote>
     *
     * <h3>FireBirdSQL</h3>
     * <blockquote><code>
     * mondrian3.foodmart.jdbcURL=jdbc:firebirdsql:localhost/3050:/mondrian/foodmart.gdb<br></br>
     * mondrian3.jdbcDrivers=org.firebirdsql.jdbc.FBDriver<br></br>
     * driver.classpath=/jdbc/fb/firebirdsql-full.jar</code></blockquote>
     *
     * <h3>Greenplum (similar to Postgres)</h3>
     * <blockquote><code>
     * mondrian3.foodmart.jdbcURL=jdbc:postgresql://localhost/foodmart?user=gpadmin&amp;password=xxxx<br></br>
     * mondrian3.foodmart.jdbcUser=foodmart<br></br>
     * mondrian3.foodmart.jdbcPassword=foodmart<br></br>
     * mondrian3.jdbcDrivers=org.postgresql.Driver<br></br>
     * driver.classpath=lib/postgresql-8.2-504.jdbc3.jar</code></blockquote>
     *
     * <h3>LucidDB (see <a>instructions</a>)</h3>
     * <blockquote><code>
     * mondrian3.foodmart.jdbcURL=jdbc:luciddb:http://localhost<br></br>
     * mondrian3.foodmart.jdbcUser=foodmart<br></br>
     * mondrian3.jdbcDrivers=org.luciddb.jdbc.LucidDbClientDriver<br></br>
     ...
     * mondrian3.foodmart.jdbcURL.oracle=jdbc:oracle:thin:@//<i>host</i>:<i>port</i>/<i>service_name</i><br></br>
     * mondrian3.foodmart.jdbcURL=jdbc:oracle:thin:foodmart/foodmart@//stilton:1521/orcl<br></br>
     * mondrian3.foodmart.jdbcURL=jdbc:oracle:oci8:foodmart/foodmart@orcl<br></br>
     * mondrian3.foodmart.jdbcUser=FOODMART<br></br>
     * mondrian3.foodmart.jdbcPassword=oracle<br></br>
     * mondrian3.jdbcDrivers=oracle.jdbc.OracleDriver<br></br>
     * driver.classpath=/home/jhyde/open/mondrian/lib/ojdbc14.jar</code></blockquote>
     *
     * <h3>ODBC (Microsoft Access)</h3>
     * <blockquote><code>
     * mondrian3.foodmart.jdbcURL=jdbc:odbc:MondrianFoodMart<br></br>
     * mondrian3.jdbcDrivers=sun.jdbc.odbc.JdbcOdbcDriver<br></br>
     * driver.classpath=</code></blockquote>
     *
     * <h3> Hypersonic</h3>
     * <blockquote><code>
     * mondrian3.foodmart.jdbcURL=jdbc:hsqldb:demo/hsql/FoodMart<br></br>
     * mondrian3.jdbcDrivers=org.hsqldb.jdbcDriver<br></br>
     * driver.classpath=xx</code></blockquote>
     *
     * <h3> MySQL: can have user and password set in JDBC URL</h3>
     * <blockquote><code>
     * mondrian3.foodmart.jdbcURL=jdbc:mysql://localhost/foodmart?user=foodmart&amp;password=foodmart<br></br>
     * mondrian3.foodmart.jdbcURL=jdbc:mysql://localhost/foodmart<br></br>
     * mondrian3.foodmart.jdbcUser=foodmart<br></br>
     * mondrian3.foodmart.jdbcPassword=foodmart<br></br>
     * mondrian3.jdbcDrivers=com.mysql.jdbc.Driver<br></br>
     ...
     * <h3>Ingres</h3>
     * <blockquote><code>
     * mondrian3.foodmart.jdbcURL=jdbc:ingres://192.168.200.129:II7/MondrianFoodMart;LOOP=on;AUTO=multi;UID=ingres;PWD=sergni<br></br>
     * mondrian3.jdbcDrivers=com.ingres.jdbc.IngresDriver<br></br>
     * driver.classpath=c:/ingres2006/ingres/lib/iijdbc.jar</code></blockquote>
     *
     * <h3>Postgres: needs user and password</h3>
     * <blockquote><code>
     * mondrian3.foodmart.jdbcURL=jdbc:postgresql://localhost/FM3<br></br>
     * mondrian3.foodmart.jdbcUser=postgres<br></br>
     * mondrian3.foodmart.jdbcPassword=pgAdmin<br></br>
     * mondrian3.jdbcDrivers=org.postgresql.Driver</code></blockquote>
     *
     * <h3>Neoview</h3>
     * <blockquote><code>
     * mondrian3.foodmart.jdbcURL=jdbc:hpt4jdbc://localhost:18650/:schema=PENTAHO;serverDataSource=PENTAHO_DataSource<br></br>
     * mondrian3.foodmart.jdbcUser=<i>user</i><br></br>
     * mondrian3.foodmart.jdbcPassword=<i>password</i><br></br>
     * mondrian3.jdbcDrivers=com.hp.t4jdbc.HPT4Driver<br></br>
     * driver.classpath=/some/path/hpt4jdbc.jar</code></blockquote>
     *
     * <h3>Netezza: mimics Postgres</h3>
     * <blockquote><code>
     * mondrian3.foodmart.jdbcURL=jdbc:netezza://127.0.1.10/foodmart<br></br>
     * mondrian3.foodmart.jdbcUser=<i>user</i><br></br>
     * mondrian3.foodmart.jdbcPassword=<i>password</i><br></br>
     * mondrian3.jdbcDrivers=org.netezza.Driver<br></br>
     * driver.classpath=/some/path/nzjdbc.jar</code></blockquote>
     *
     * <h3>Sybase</h3>
     * <blockquote><code>
     * mondrian3.foodmart.jdbcURL=jdbc:jtds:sybase://xxx.xxx.xxx.xxx:<i>port</i>/<i>dbName</i><br></br>
     * mondrian3.foodmart.jdbcUser=<i>user</i><br></br>
     * mondrian3.foodmart.jdbcPassword=<i>password</i><br></br>
     * mondrian3.jdbcDrivers=net.sourceforge.jtds.jdbc.Driver<br></br>
     * driver.classpath=/some/path/jtds-1.2.jar</code></blockquote>
     *
     * <h3>Teradata</h3>
     * <blockquote><code>
     * mondrian3.foodmart.jdbcURL=jdbc:teradata://DatabaseServerName/DATABASE=FoodMart<br></br>
     * mondrian3.foodmart.jdbcUser=<i>user</i><br></br>
     * mondrian3.foodmart.jdbcPassword=<i>password</i><br></br>
     * mondrian3.jdbcDrivers=com.ncr.teradata.TeraDriver<br></br>
     * driver.classpath=/some/path/terajdbc/classes/terajdbc4.jar</code></blockquote>
     *
     * <h3>Vertica</h3>
     * <blockquote><code>
     * mondrian3.foodmart.jdbcURL=jdbc:vertica://xxx.xxx.xxx.xxx:<i>port</i>/<i>dbName</i><br></br>
     * mondrian3.foodmart.jdbcUser=<i>user</i><br></br>
     * mondrian3.foodmart.jdbcPassword=<i>password</i><br></br>
     * mondrian3.jdbcDrivers=com.vertica.Driver<br></br>
     * driver.classpath=/some/path/vertica.jar</code></blockquote>
     *
     * <h3>Vectorwise</h3>
     * <blockquote><code>
     * mondrian3.foodmart.jdbcURL=jdbc:ingres://xxx.xxx.xxx.xxx<i>port</i>/<i>dbName</i><br></br>
     * mondrian3.foodmart.jdbcUser=<i>user</i><br></br>
     * mondrian3.foodmart.jdbcPassword=<i>password</i><br></br>
     * mondrian3.jdbcDrivers=com.ingres.jdbc.IngresDriver <br></br>
    ...
    public transient final StringProperty FoodmartJdbcURL =
        new StringProperty(
            this, "mondrian3.foodmart.jdbcURL", "jdbc:odbc:MondrianFoodMart");
    ...
    public transient final BooleanProperty GenerateAggregateSql =
        new BooleanProperty(
            this, "mondrian3.rolap.aggregates.generateSql", false);
    ...
    public transient final BooleanProperty IgnoreInvalidMembers =
        new BooleanProperty(
            this, "mondrian3.rolap.ignoreInvalidMembers", false);
    ...
    public transient final BooleanProperty IgnoreInvalidMembersDuringQuery =
        new BooleanProperty(
            this, "mondrian3.rolap.ignoreInvalidMembersDuringQuery", false);
     ...
     *
     * <p>With mondrian3.olap.agg.IgnoreMeasureForNonJoiningDimension=true
     ...
     *
     * <p>With mondrian3.olap.agg.IgnoreMeasureForNonJoiningDimension=false
    ...
    public transient final BooleanProperty IgnoreMeasureForNonJoiningDimension =
        new BooleanProperty(
            this, "mondrian3.olap.agg.IgnoreMeasureForNonJoiningDimension", false);
    ...
    public transient final IntegerProperty IterationLimit =
        new IntegerProperty(
            this, "mondrian3.rolap.iterationLimit", 0);
    ...
    public transient final IntegerProperty Iterations =
        new IntegerProperty(
            this, "mondrian3.test.Iterations", 1);
    ...
    public transient final StringProperty JdbcDrivers =
        new StringProperty(
            this, "mondrian3.jdbcDrivers", "sun.jdbc.odbc.JdbcOdbcDriver,org.hsqldb.jdbcDriver,oracle.jdbc.OracleDriver,com.mysql.jdbc.Driver");
     ...
     *
     * @see mondrian3.rolap.aggmatcher.JdbcSchema
     */
    public transient final StringProperty JdbcFactoryClass =
        new StringProperty(
            this, "mondrian3.rolap.aggregates.jdbcFactoryClass", null);
     ...
     *
     * <p>Used for the {@link mondrian3.i18n.LocalizingDynamicSchemaProcessor};
    ...
    public transient final StringProperty LocalePropFile =
        new StringProperty(
            this, "mondrian3.rolap.localePropFile", null);
    ...
    public transient final IntegerProperty MaxConstraints =
        new IntegerProperty(
            this, "mondrian3.rolap.maxConstraints", 1000);
    ...
    public transient final IntegerProperty MaxEvalDepth =
        new IntegerProperty(
            this, "mondrian3.rolap.evaluate.MaxEvalDepth", 10);
    ...
    public transient final IntegerProperty MaxRows =
        new IntegerProperty(
            this, "mondrian3.xmla.drillthroughMaxRows", 1000);
    ...
    public transient final BooleanProperty MemoryMonitor =
        new BooleanProperty(
            this, "mondrian3.util.memoryMonitor.enable", false);
    ...
    public transient final StringProperty MemoryMonitorClass =
        new StringProperty(
            this, "mondrian3.util.MemoryMonitor.class", null);
    ...
    public transient final IntegerProperty MemoryMonitorThreshold =
        new IntegerProperty(
            this, "mondrian3.util.memoryMonitor.percentage.threshold", 90);
    ...
    public transient final IntegerProperty NativizeMaxResults =
        new IntegerProperty(
            this, "mondrian3.native.NativizeMaxResults", 150000);
    ...
    public transient final IntegerProperty NativizeMinThreshold =
        new IntegerProperty(
            this, "mondrian3.native.NativizeMinThreshold", 100000);
    ...
    public transient final BooleanProperty NeedDimensionPrefix =
        new BooleanProperty(
            this, "mondrian3.olap.elements.NeedDimensionPrefix", false);
    ...
    public transient final BooleanProperty NullDenominatorProducesNull =
        new BooleanProperty(
            this, "mondrian3.olap.NullDenominatorProducesNull", false);
    ...
    public transient final StringProperty NullMemberRepresentation =
        new StringProperty(
            this, "mondrian3.olap.NullMemberRepresentation", "#null");
    ...
    public transient final BooleanProperty OptimizePredicates =
        new BooleanProperty(
            this, "mondrian3.rolap.aggregates.optimizePredicates", true);
     ...
     * {@link mondrian3.rolap.RolapMemberBase.DefaultPropertyValueMapFactory}
     * will be used.</p>
     */
    public transient final StringProperty PropertyValueMapFactoryClass =
        new StringProperty(
            this, "mondrian3.rolap.RolapMember.PropertyValueMapFactory.class", null);
    ...
    public transient final StringProperty QueryFileDirectory =
        new StringProperty(
            this, "mondrian3.test.QueryFileDirectory", null);
     ...
     *
     * <blockquote><code>
     * mondrian3.test.QueryFilePattern=queryTest_fec[A-Za-z0-9_]*.xml
     * </code></blockquote>
     */
    public transient final StringProperty QueryFilePattern =
        new StringProperty(
            this, "mondrian3.test.QueryFilePattern", null);
    ...
    public transient final IntegerProperty QueryTimeout =
        new IntegerProperty(
            this, "mondrian3.rolap.queryTimeout", 0);
     ...
     * Unless mondrian3.rolap.aggregates.Use is set to true, the aggregates
     * found will not be used.</p>
     */
    public transient final BooleanProperty ReadAggregates =
        new BooleanProperty(
            this, "mondrian3.rolap.aggregates.Read", false);
    ...
    public transient final IntegerProperty RolapConnectionShepherdNbThreads =
        new IntegerProperty(
            this, "mondrian3.rolap.maxQueryThreads", 10);
     ...
     * mondrian3.rolap.queryTimeout will result the timeout not being enforced
     * as expected.</p>
     *
    ...
    public transient final StringProperty RolapConnectionShepherdThreadPollingInterval =
        new StringProperty(
            this, "mondrian3.rolap.shepherdThreadPollingInterval", "1000ms");
     ...
     * is an implementation of {@link mondrian3.spi.SegmentCache}.
     */
    public transient final StringProperty SegmentCache =
        new StringProperty(
            this, "mondrian3.rolap.SegmentCache", null);
    ...
    public transient final IntegerProperty SegmentCacheManagerNumberCacheThreads =
        new IntegerProperty(
            this, "mondrian3.rolap.maxCacheThreads", 100);
    ...
    public transient final IntegerProperty SegmentCacheManagerNumberSqlThreads =
        new IntegerProperty(
            this, "mondrian3.rolap.maxSqlThreads", 100);
     ...
     * {@link mondrian3.olap.SolveOrderMode} for details.</p>
     */
    public transient final StringProperty SolveOrderMode =
        new StringProperty(
            this, "mondrian3.rolap.SolveOrderMode", "ABSOLUTE");
    ...
    public transient final IntegerProperty SparseSegmentCountThreshold =
        new IntegerProperty(
            this, "mondrian3.rolap.SparseSegmentValueThreshold", 1000);
    ...
    public transient final DoubleProperty SparseSegmentDensityThreshold =
        new DoubleProperty(
            this, "mondrian3.rolap.SparseSegmentDensityThreshold", 0.5);
     ...
     * {@link mondrian3.rolap.SqlMemberSource.NullValuePoolFactory}
    ...
    public transient final StringProperty SqlMemberSourceValuePoolFactoryClass =
        new StringProperty(
            this, "mondrian3.rolap.SqlMemberSource.ValuePoolFactory.class", null);
    ...
    public transient final BooleanProperty SsasCompatibleNaming =
        new BooleanProperty(
            this, "mondrian3.olap.SsasCompatibleNaming", false);
     ...
     *
     * <p>If there is a value for mondrian3.statistics.providers.DATABASE, where
     ...
     *
     * <blockquote><code>
     * mondrian3.statistics.providers=mondrian3.spi.impl.JdbcStatisticsProvider<br></br>
     * mondrian3.statistics.providers.MYSQL=mondrian3.spi.impl.JdbcStatisticsProvider,mondrian3.spi.impl.JdbcStatisticsProvider</code></blockquote>
     *
    ...
    public transient final StringProperty StatisticsProviders =
        new StringProperty(
            this, "mondrian3.statistics.providers", null);
     ...
     * <p>Example:</p>
     *
     * <blockquote><code>mondrian3.test.Class=mondrian3.test.FoodMartTestCase</code></blockquote>
     *
     * @see #TestName
     */
    public transient final StringProperty TestClass =
        new StringProperty(
            this, "mondrian3.test.Class", null);
    ...
    public transient final StringProperty TestConnectString =
        new StringProperty(
            this, "mondrian3.test.connectString", null);
    ...
    public transient final IntegerProperty TestExpDependencies =
        new IntegerProperty(
            this, "mondrian3.test.ExpDependencies", 0);
    ...
    public transient final StringProperty TestHighCardinalityDimensionList =
        new StringProperty(
            this, "mondrian3.test.highCardDimensions", null);
    ...
    public transient final StringProperty TestJdbcPassword =
        new StringProperty(
            this, "mondrian3.foodmart.jdbcPassword", null);
    ...
    public transient final StringProperty TestJdbcUser =
        new StringProperty(
            this, "mondrian3.foodmart.jdbcUser", null);
    ...
    public transient final IntegerProperty TestSeed =
        new IntegerProperty(
            this, "mondrian3.test.random.seed", 1234);
    ...
    public transient final IntegerProperty TimeLimit =
        new IntegerProperty(
            this, "mondrian3.test.TimeLimit", 0);
    ...
    public transient final BooleanProperty UseAggregates =
        new BooleanProperty(
            this, "mondrian3.rolap.aggregates.Use", false);
    ...
    public transient final BooleanProperty Warmup =
        new BooleanProperty(
            this, "mondrian3.test.Warmup", false);
     ...
     * <li>Settings besides "ANY" in mondrian3.properties file</li>
    ...
    public transient final StringProperty WarnIfNoPatternForDialect =
        new StringProperty(
            this, "mondrian3.test.WarnIfNoPatternForDialect", "NONE");
     ...
     *
     * <p>See also
     * {@link mondrian3.xmla.impl.DynamicDatasourceXmlaServlet}.</p>
     */
    public transient final StringProperty XmlaSchemaRefreshInterval =
        new StringProperty(
            this, "mondrian3.xmla.SchemaRefreshInterval", "3000ms");
