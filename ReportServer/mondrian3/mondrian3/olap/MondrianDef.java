 ...
 * Revision is $Id$
 * <p>This class was generated from XOM model 'mondrian' on Sat Apr 26 17:31:55 EDT 2014
 */
...
public Expression getKeyExp() {
            ...
            public mondrian3.spi.Dialect.Datatype getDatatype() {
                return mondrian3.spi.Dialect.Datatype.valueOf(type);
            }
		// END pass-through code block ---
	}
...
/**
            ...
            public String getFormatString() {
                for (CalculatedMemberProperty prop : memberProperties) {
                    if (prop.name.equals(
                        mondrian3.olap.Property.FORMAT_STRING.name))
                    {
                        return prop.value;
                    }
                }
...
public int hashCode() {
             ...
             * {@link mondrian3.rolap.sql.SqlQuery.CodeSet} object.
             */
...
public String toString() {
	 ...
	 * See mondrian3.olap.Role#grant(mondrian3.olap.Schema,int).
	 */
	 ...
	 * See mondrian3.olap.Role#grant(mondrian3.olap.Cube,int).
	 */
	 ...
	 * See mondrian3.olap.Role#grant(mondrian3.olap.Dimension,int).
	 */
	 ...
	 * See mondrian3.olap.Role#grant(mondrian3.olap.Hierarchy, int, mondrian3.olap.Level).
	 */
	 ...
	 * See mondrian3.olap.Role#grant(mondrian3.olap.Member,int).
	 */
	 ...
	 * mondrian3.spi.UserDefinedFunction.
	 */
	 ...
	 * It must be implemented by a Java
	 * class which implements the interface
	 * mondrian3.spi.PropertyFormatter,
	 * or by a script.
	 */
