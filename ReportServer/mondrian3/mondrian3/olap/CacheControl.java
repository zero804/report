 ...
 * {@link mondrian3.olap.Connection#getCacheControl}.</p>
 *
 ...
 * <li>{@link #createUnionRegion(mondrian3.olap.CacheControl.CellRegion[])}</li>
 * <li>{@link #createCrossjoinRegion(mondrian3.olap.CacheControl.CellRegion[])}</li>
 * <li>{@link #createMeasuresRegion(Cube)}</li>
 * <li>{@link #flush(mondrian3.olap.CacheControl.CellRegion)}</li>
 * </ul></p>
 *
 ...
 * <li>{@link #createDeleteCommand(mondrian3.olap.CacheControl.MemberSet)}</li>
 * <li>{@link #createCompoundCommand(java.util.List)}</li>
 * <li>{@link #createCompoundCommand(mondrian3.olap.CacheControl.MemberEditCommand[])}</li>
 * <li>{@link #createSetPropertyCommand(Member, String, Object)}</li>
 * <li>{@link #createSetPropertyCommand(mondrian3.olap.CacheControl.MemberSet,java.util.Map)}</li>
 * <li>{@link #flush(mondrian3.olap.CacheControl.MemberSet)}</li>
 * <li>{@link #execute(mondrian3.olap.CacheControl.MemberEditCommand)}</li>
 * </ul></p>
 *
 * @author jhyde
 * @since Sep 27, 2006
...
public interface CacheControl {
    ...
    public interface CellRegion {
         ...
         * @return a list of {@link mondrian3.olap.Dimension} objects.
         */
     ...
     * {@link CacheControl#createUnionSet(mondrian3.olap.CacheControl.MemberSet[])}.
     */
