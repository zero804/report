...
public class FunUtil extends Util {
     ...
     * has returned the MDX null value. See {@link mondrian3.calc.IntegerCalc}.
     */
     ...
     * {@link #evaluateTuples(mondrian3.olap.Evaluator, mondrian3.calc.Calc, mondrian3.calc.TupleList)}.
     *
     ...
     *
     * @see #hierarchizeTupleList(mondrian3.calc.TupleList, boolean)
     */
    ...
    */
     ...
     *
     *
     * @param evaluator Evaluator, provides a {@link mondrian3.olap.SchemaReader}
     *   and {@link mondrian3.olap.Cube}
