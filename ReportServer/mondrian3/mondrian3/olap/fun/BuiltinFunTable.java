...
import mondrian3.olap.fun.extra.CalculatedChildFunDef;
import mondrian3.olap.fun.extra.NthQuartileFunDef;
import mondrian3.olap.fun.vba.Excel;
import mondrian3.olap.fun.vba.Vba;
    ...
    public void defineFunctions(Builder builder) {
                ...
                "innn")
        {
            public Calc compileCall(ResolvedFunCall call, ExpCompiler compiler)
            {
                ...
                //   mondrian3.olap.NullOrZeroDenominatorProducesNull
