...
public interface FunTable {
    ...
    /**
     * Returns a list of {@link mondrian3.olap.fun.Resolver} objects.
     */
    ...
    /**
     * Returns a list of {@link mondrian3.olap.fun.FunInfo} objects.
     */
     ...
     *
     * <p>An implementation of {@link mondrian3.olap.FunTable} must register all
     * of its functions and operators by making callbacks during its
     * {@link mondrian3.olap.FunTable#defineFunctions(mondrian3.olap.FunTable.Builder)}
     * method.
     */
    public interface Builder {
         ...
         *
         * @see mondrian3.olap.FunTable#isReserved
         */
