 ...
 * {@link mondrian3.spi.DialectFactory} for more details.</p>
 *
 * <h3>Registering dialects</h3>
 *
 * <p>A dialect needs to be registered with the system in order to be used.
 * Call {@link mondrian3.spi.DialectManager#register(DialectFactory)}
 * to register a dialect factory, or
 * {@link mondrian3.spi.DialectManager#register(Class)} to register a dialect
 * class.
 *
 ...
 *     "<code>META-INF/services/mondrian3.spi.Dialect</code>", containing the
 ...
 * {@link mondrian3.spi.impl.JdbcDialectImpl}, to help to make your
 ...
 * regression tests. In particular, get {@code mondrian3.test.DialectTest} to run
 * cleanly first; this will ensure that the dialect's claims are consistent with
 * the actual behavior of your database.</p>
 *
 * @see mondrian3.spi.DialectFactory
 * @see mondrian3.spi.DialectManager
 *
 * @author jhyde
 * @since Oct 10, 2008
 */
public interface Dialect {
     ...
     * {@link mondrian3.spi.Dialect.DatabaseProduct#UNKNOWN} if the database is
     ...
     *
     * @see mondrian3.spi.DialectFactory#createDialect(javax.sql.DataSource, java.sql.Connection)
     *
     ...
     * {@code mondrian3.statistics.providers.PRODUCT} where product is the
     * current dialect's product name (for example "MYSQL"). If that property
     * has no value, looks at the property
     * {@code mondrian3.statistics.providers}. The property value should be
