...
import mondrian3.spi.impl.JdbcDialectFactory;
import mondrian3.spi.impl.JdbcDialectImpl;
...
/**
 * Manages {@link mondrian3.spi.Dialect} and {@link mondrian3.spi.DialectFactory}
 * objects.
 *
 * @author jhyde
 * @since Jan 13, 2009
...
public abstract class DialectManager {
    ...
    /**
     * Implementation class for {@link mondrian3.spi.DialectManager}.
     *
    ...
    private static class DialectManagerImpl {
         ...
         * {@link mondrian3.util.ServiceDiscovery} for more details.)
         */
        DialectManagerImpl() {
    ...
    /**
     * Implementation of {@link mondrian3.spi.DialectFactory} that caches
     * dialects based on data source.
     *
     * @see mondrian3.spi.Dialect#allowsDialectSharing()
     */
