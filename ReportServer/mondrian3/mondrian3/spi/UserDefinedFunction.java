...
public interface UserDefinedFunction {
    ...
    interface Argument {
         ...
         * {@link #evaluate(mondrian3.olap.Evaluator)} except if the argument
         ...
         * {@link #evaluateList(mondrian3.olap.Evaluator)} or
         * {@link #evaluateIterable(mondrian3.olap.Evaluator)}.
         *
         * @param evaluator Evaluation context
