...
import mondrian3.spi.Dialect.DatabaseProduct;
...
public class JdbcDialectImpl implements Dialect {
    ...
    private List<String> getStatisticsProviderNames() {
        // Dialect-specific path, e.g. "mondrian3.statistics.providers.MYSQL"
        final String path =
        ...
        // Generic property, "mondrian3.statistics.providers"
