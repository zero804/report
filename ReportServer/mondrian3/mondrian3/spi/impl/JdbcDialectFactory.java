...
import mondrian3.spi.DialectFactory;
...
/**
 * Implementation of {@link mondrian3.spi.DialectFactory} for subclasses
 * of {@link mondrian3.spi.impl.JdbcDialectImpl}.
 *
...
public class JdbcDialectFactory implements DialectFactory {
     ...
     * {@link mondrian3.spi.DialectFactory#createDialect(javax.sql.DataSource, java.sql.Connection)}.
     *
