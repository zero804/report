 ...
 * mondrian3. The first one is to set the
 ...
 * <code>/META-INF/services/mondrian3.spi.SegmentCache</code> which contains
 ...
 * cache implementation is not part of the same class loader as mondrian3.
