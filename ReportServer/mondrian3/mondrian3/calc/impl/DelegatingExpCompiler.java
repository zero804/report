...
/**
 * Abstract implementation of {@link mondrian3.calc.ExpCompiler}
 *
 * @author jhyde
 * @since Jan 2, 2006
 */
public class DelegatingExpCompiler implements ExpCompiler {
     ...
     * {@link #afterCompile(mondrian3.olap.Exp, mondrian3.calc.Calc, boolean)}
    ...
    /**
     * See {@link mondrian3.calc.impl.DelegatingExpCompiler#wrap}.
     */
