...
import mondrian3.calc.impl.BetterExpCompiler;
import mondrian3.olap.*;
import mondrian3.olap.type.Type;
import mondrian3.util.CreationException;
import mondrian3.util.ObjectFactory;
...
/**
 * Mediates the compilation of an expression ({@link mondrian3.olap.Exp})
...
public interface ExpCompiler {
     ...
     *
     * <p>See {@link #compileList(mondrian3.olap.Exp)}.
     *
     * @param exp Expression
     ...
     *   {@link #compileString(mondrian3.olap.Exp)}
