 ...
 * from /build/artifacts/jenkins-50/jobs/mondrian-jar/workspace/src/main/mondrian/resource/MondrianResource.xml
 * on Sat Apr 26 17:31:54 EDT 2014.
...
public class MondrianResource extends org.eigenbase.resgen.ShadowResourceBundle {
    ...
    private static final String baseName = "mondrian3.resource.MondrianResource";
    /**
    ...
    /**
     * <code>SegmentCacheIsNotImplementingInterface</code> is '<code>The mondrian3.rolap.SegmentCache property points to a class name which is not an
     * implementation of mondrian3.spi.SegmentCache.</code>'
     */
    public final _Def3 SegmentCacheIsNotImplementingInterface = new _Def3("SegmentCacheIsNotImplementingInterface", "The mondrian3.rolap.SegmentCache property points to a class name which is not an\n        implementation of mondrian3.spi.SegmentCache.", null);
    ...
    /**
     * <code>NativeSqlInClauseTooLarge</code> is '<code>Cannot use native aggregation constraints for level &#39;&#39;{0}&#39;&#39; because the number of members is larger than the value of &#39;&#39;mondrian3.rolap.maxConstraints&#39;&#39; ({1})</code>'
     */
    public final _Def9 NativeSqlInClauseTooLarge = new _Def9("NativeSqlInClauseTooLarge", "Cannot use native aggregation constraints for level ''{0}'' because the number of members is larger than the value of ''mondrian3.rolap.maxConstraints'' ({1})", null);
    ...
    /**
     * <code>SqlQueryLimitReached</code> is '<code>The number of concurrent SQL statements which can be used simultaneously by this Mondrian server instance has been reached. Set &#39;&#39;mondrian3.rolap.maxSqlQueryThreads&#39;&#39; to change the current limit.</code>'
     */
    public final _Def3 SqlQueryLimitReached = new _Def3("SqlQueryLimitReached", "The number of concurrent SQL statements which can be used simultaneously by this Mondrian server instance has been reached. Set ''mondrian3.rolap.maxSqlQueryThreads'' to change the current limit.", null);

    /**
     * <code>SegmentCacheLimitReached</code> is '<code>The number of concurrent segment cache operations which can be run simultaneously by this Mondrian server instance has been reached. Set &#39;&#39;mondrian3.rolap.maxCacheThreads&#39;&#39; to change the current limit.</code>'
     */
    public final _Def3 SegmentCacheLimitReached = new _Def3("SegmentCacheLimitReached", "The number of concurrent segment cache operations which can be run simultaneously by this Mondrian server instance has been reached. Set ''mondrian3.rolap.maxCacheThreads'' to change the current limit.", null);
     ...
     * return a {@link mondrian3.olap.MondrianException} exception and
    ...
    public final class _Def0 extends org.eigenbase.resgen.ResourceDefinition {
        ...
        public mondrian3.olap.MondrianException ex(String p0) {
            return new mondrian3.olap.MondrianException(instantiate(MondrianResource.this, new Object[] {p0}).toString());
        }
        public mondrian3.olap.MondrianException ex(String p0, Throwable err) {
            return new mondrian3.olap.MondrianException(instantiate(MondrianResource.this, new Object[] {p0}).toString(), err);
        }
    }
    ...
    public final class _Def1 extends org.eigenbase.resgen.ResourceDefinition {
        ...
        public mondrian3.olap.MondrianException ex(String p0, String p1) {
            return new mondrian3.olap.MondrianException(instantiate(MondrianResource.this, new Object[] {p0, p1}).toString());
        }
        public mondrian3.olap.MondrianException ex(String p0, String p1, Throwable err) {
            return new mondrian3.olap.MondrianException(instantiate(MondrianResource.this, new Object[] {p0, p1}).toString(), err);
        }
    }
    ...
    public final class _Def3 extends org.eigenbase.resgen.ResourceDefinition {
        ...
        public mondrian3.olap.MondrianException ex() {
            return new mondrian3.olap.MondrianException(instantiate(MondrianResource.this, emptyObjectArray).toString());
        }
        public mondrian3.olap.MondrianException ex(Throwable err) {
            return new mondrian3.olap.MondrianException(instantiate(MondrianResource.this, emptyObjectArray).toString(), err);
        }
    }
    ...
    public final class _Def4 extends org.eigenbase.resgen.ResourceDefinition {
        ...
        public mondrian3.olap.MondrianException ex(String p0, String p1, String p2) {
            return new mondrian3.olap.MondrianException(instantiate(MondrianResource.this, new Object[] {p0, p1, p2}).toString());
        }
        public mondrian3.olap.MondrianException ex(String p0, String p1, String p2, Throwable err) {
            return new mondrian3.olap.MondrianException(instantiate(MondrianResource.this, new Object[] {p0, p1, p2}).toString(), err);
        }
    }
    ...
    public final class _Def6 extends org.eigenbase.resgen.ResourceDefinition {
        ...
        public mondrian3.olap.MondrianException ex(Number p0, String p1) {
            return new mondrian3.olap.MondrianException(instantiate(MondrianResource.this, new Object[] {p0, p1}).toString());
        }
        public mondrian3.olap.MondrianException ex(Number p0, String p1, Throwable err) {
            return new mondrian3.olap.MondrianException(instantiate(MondrianResource.this, new Object[] {p0, p1}).toString(), err);
        }
    }
    ...
    public final class _Def7 extends org.eigenbase.resgen.ResourceDefinition {
        ...
        public mondrian3.olap.MondrianException ex(String p0, String p1, String p2, String p3) {
            return new mondrian3.olap.MondrianException(instantiate(MondrianResource.this, new Object[] {p0, p1, p2, p3}).toString());
        }
        public mondrian3.olap.MondrianException ex(String p0, String p1, String p2, String p3, Throwable err) {
            return new mondrian3.olap.MondrianException(instantiate(MondrianResource.this, new Object[] {p0, p1, p2, p3}).toString(), err);
        }
    }
    ...
    public final class _Def8 extends org.eigenbase.resgen.ResourceDefinition {
        ...
        public mondrian3.olap.MondrianException ex(Number p0) {
            return new mondrian3.olap.MondrianException(instantiate(MondrianResource.this, new Object[] {p0}).toString());
        }
        public mondrian3.olap.MondrianException ex(Number p0, Throwable err) {
            return new mondrian3.olap.MondrianException(instantiate(MondrianResource.this, new Object[] {p0}).toString(), err);
        }
    }
    ...
    /**
     * Definition for resources which
     * return a {@link mondrian3.olap.ResourceLimitExceededException} exception and
    ...
    public final class _Def10 extends org.eigenbase.resgen.ResourceDefinition {
        ...
        public mondrian3.olap.ResourceLimitExceededException ex(Number p0, Number p1) {
            return new mondrian3.olap.ResourceLimitExceededException(instantiate(MondrianResource.this, new Object[] {p0, p1}).toString());
        }
    }
    ...
    public final class _Def11 extends org.eigenbase.resgen.ResourceDefinition {
        ...
        public mondrian3.olap.ResourceLimitExceededException ex(Number p0) {
            return new mondrian3.olap.ResourceLimitExceededException(instantiate(MondrianResource.this, new Object[] {p0}).toString());
        }
    }

    /**
     * Definition for resources which
     * return a {@link mondrian3.olap.QueryCanceledException} exception and
     * take arguments ''.
     */
    public final class _Def12 extends org.eigenbase.resgen.ResourceDefinition {
        ...
        public mondrian3.olap.QueryCanceledException ex() {
            return new mondrian3.olap.QueryCanceledException(instantiate(MondrianResource.this, emptyObjectArray).toString());
        }
    }

    /**
     * Definition for resources which
     * return a {@link mondrian3.olap.QueryTimeoutException} exception and
     * take arguments 'Number p0'.
     */
    public final class _Def13 extends org.eigenbase.resgen.ResourceDefinition {
        ...
        public mondrian3.olap.QueryTimeoutException ex(Number p0) {
            return new mondrian3.olap.QueryTimeoutException(instantiate(MondrianResource.this, new Object[] {p0}).toString());
        }
    }

    /**
     * Definition for resources which
     * return a {@link mondrian3.olap.InvalidHierarchyException} exception and
     * take arguments 'String p0'.
     */
    public final class _Def14 extends org.eigenbase.resgen.ResourceDefinition {
        ...
        public mondrian3.olap.InvalidHierarchyException ex(String p0) {
            return new mondrian3.olap.InvalidHierarchyException(instantiate(MondrianResource.this, new Object[] {p0}).toString());
        }
    }
    ...
    /**
     * Definition for resources which
     * return a {@link mondrian3.olap.NativeEvaluationUnsupportedException} exception and
     * take arguments 'String p0'.
     */
    public final class _Def22 extends org.eigenbase.resgen.ResourceDefinition {
        ...
        public mondrian3.olap.NativeEvaluationUnsupportedException ex(String p0) {
            return new mondrian3.olap.NativeEvaluationUnsupportedException(instantiate(MondrianResource.this, new Object[] {p0}).toString());
        }
    }
