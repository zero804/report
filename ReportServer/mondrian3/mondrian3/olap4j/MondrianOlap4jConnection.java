...
public abstract class MondrianOlap4jConnection implements OlapConnection {
     ...
     */
    final Map<mondrian3.olap.Schema, MondrianOlap4jSchema> schemaMap =
        new HashMap<mondrian3.olap.Schema, MondrianOlap4jSchema>();
        ...
        throws SQLException
    {
        ...
        this.mondrianConnection =
            (RolapConnection) mondrian3.olap.DriverManager
    ...
    MondrianOlap4jCube toOlap4j(mondrian3.olap.Cube cube) {
        MondrianOlap4jSchema schema = toOlap4j(cube.getSchema());
        return new MondrianOlap4jCube(cube, schema);
    }

    MondrianOlap4jDimension toOlap4j(mondrian3.olap.Dimension dimension) {
        if (dimension == null) {
            return null;
        }
    ...
    Type toOlap4j(mondrian3.olap.type.Type type) {
        if (type instanceof mondrian3.olap.type.BooleanType) {
            return new BooleanType();
        } else if (type instanceof mondrian3.olap.type.CubeType) {
            final mondrian3.olap.Cube mondrianCube =
                ((mondrian3.olap.type.CubeType) type).getCube();
            return new CubeType(toOlap4j(mondrianCube));
        } else if (type instanceof mondrian3.olap.type.DecimalType) {
            mondrian3.olap.type.DecimalType decimalType =
                (mondrian3.olap.type.DecimalType) type;
            return new DecimalType(
                decimalType.getPrecision(),
                decimalType.getScale());
        } else if (type instanceof mondrian3.olap.type.DimensionType) {
            mondrian3.olap.type.DimensionType dimensionType =
                (mondrian3.olap.type.DimensionType) type;
            return new DimensionType(
                toOlap4j(dimensionType.getDimension()));
        } else if (type instanceof mondrian3.olap.type.HierarchyType) {
            return new BooleanType();
        } else if (type instanceof mondrian3.olap.type.LevelType) {
            return new BooleanType();
        } else if (type instanceof mondrian3.olap.type.MemberType) {
            final mondrian3.olap.type.MemberType memberType =
                (mondrian3.olap.type.MemberType) type;
        ...
        } else if (type instanceof mondrian3.olap.type.NullType) {
            return new NullType();
        } else if (type instanceof mondrian3.olap.type.NumericType) {
            return new NumericType();
        } else if (type instanceof mondrian3.olap.type.SetType) {
            final mondrian3.olap.type.SetType setType =
                (mondrian3.olap.type.SetType) type;
            return new SetType(toOlap4j(setType.getElementType()));
        } else if (type instanceof mondrian3.olap.type.StringType) {
            return new StringType();
        } else if (type instanceof mondrian3.olap.type.TupleType) {
            mondrian3.olap.type.TupleType tupleType =
                (mondrian3.olap.type.TupleType) type;
            final Type[] types = toOlap4j(tupleType.elementTypes);
            return new TupleType(types);
        } else if (type instanceof mondrian3.olap.type.SymbolType) {
    ...
    MondrianOlap4jMember toOlap4j(mondrian3.olap.Member member) {
        if (member == null) {
            return null;
        }
    ...
    MondrianOlap4jLevel toOlap4j(mondrian3.olap.Level level) {
        if (level == null) {
            return null;
        }
    ...
    MondrianOlap4jHierarchy toOlap4j(mondrian3.olap.Hierarchy hierarchy) {
        if (hierarchy == null) {
            return null;
        }
    ...
    Type[] toOlap4j(mondrian3.olap.type.Type[] mondrianTypes) {
    ...
    static class Helper {
            ...
            String msg, Throwable cause)
        {
            ...
            assert !mondrian3.util.Bug.olap4jUpgrade(
    ...
    private static class MondrianToOlap4jNodeConverter {
        ...
        private org.olap4j.mdx.Syntax toOlap4j(mondrian3.olap.Syntax syntax) {
