...
/**
 * Olap4j driver for mondrian3.
 *
 * <p>Since olap4j is a superset of JDBC, you register this driver as you would
 * any JDBC driver:
 *
 * <blockquote>
 * <code>Class.forName("mondrian3.olap4j.MondrianOlap4jDriver");</code>
 * </blockquote>
 *
 ...
 * connection. See {@link mondrian3.rolap.RolapConnectionProperties}.
 *
...
public class MondrianOlap4jDriver implements Driver {
    ...
    //we don't register the Mondrian 3 driver, as this is loaded manually
//    static {
//        try {
//            register();
