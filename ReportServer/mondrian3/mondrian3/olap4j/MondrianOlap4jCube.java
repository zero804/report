...
{
    final mondrian3.olap.Cube cube;
    ...
    public NamedList<Dimension> getDimensions() {
        ...
        final mondrian3.olap.SchemaReader schemaReader =
            ...
            .withLocus();
        for (mondrian3.olap.Dimension dimension
    ...
    public List<Measure> getMeasures() {
        ...
        try {
            ...
            List<mondrian3.olap.Member> levelMembers =
                schemaReader.getLevelMembers(
                    measuresLevel.level,
                    true);
            for (mondrian3.olap.Member member : levelMembers) {
                ...
                // mondrian3.olap4j.MondrianOlap4jMember cannot be cast to
    ...
    public NamedList<NamedSet> getSets() {
        ...
        final MondrianOlap4jConnection olap4jConnection =
            olap4jSchema.olap4jCatalog.olap4jDatabaseMetaData.olap4jConnection;
        for (mondrian3.olap.NamedSet namedSet : cube.getNamedSets()) {
    ...
    private MondrianOlap4jMember lookupMember(
        ...
        List<IdentifierSegment> nameParts)
    {
        final List<mondrian3.olap.Id.Segment> segmentList =
            new ArrayList<mondrian3.olap.Id.Segment>();
