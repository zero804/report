...
import mondrian3.olap.Category;
import mondrian3.olap.*;
import mondrian3.olap.Connection;
import mondrian3.olap.DriverManager;
import mondrian3.olap.Hierarchy;
import mondrian3.olap.fun.FunInfo;
...
public class CmdRunner {
    ...
    public Expr parseParameter(String value) {
        ...
        } else if (element instanceof mondrian3.olap.Level) {
            mondrian3.olap.Level level = (mondrian3.olap.Level) element;
    ...
    /**
     * Gets a connection to mondrian3.
     *
...
*/
    ...
    protected static void usage(String msg, PrintStream out) {
        ...
        buf.append(
            "Usage: mondrian3.tui.CmdRunner args"
            + nl
            + "  args:"
            + nl
    ...
    private static void setDefaultCommentState() {
        allowNestedComments = mondrian3.olap.Scanner.getNestedCommentsState();
        String[][] scannerCommentsDelimiters =
            mondrian3.olap.Scanner.getCommentDelimiters();
