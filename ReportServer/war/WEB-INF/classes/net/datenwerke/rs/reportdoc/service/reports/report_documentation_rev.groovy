...
mainConfigTemplate += '<div class="columnL"><b>'+getLocalText("revision")+ ':</b></div><div class="columnR">' + revision + '</div>'

if(report instanceof ReportVariant)
	mainConfigTemplate += '<div class="columnL"><b>'+getLocalText("baseReport")+':</b></div><div class="columnR">' + report.getParent()?.getName() + '</div>'
