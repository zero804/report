    ...
    create table RS_TEXT_PARAM_DEF (
        ...
        height int,
        return_null_when_empty bit not null,
        return_type int,
    ...
    insert into RS_SCHEMAINFO(KEY_FIELD, value) VALUES('version', 'RS3.3.0-6030');
    insert into RS_SCHEMAINFO(KEY_FIELD, value) VALUES('schemaversion', 'RS3.0-17');
