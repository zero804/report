...
import org.legacysaiku.olap.query.QueryProperties.QueryProperty;
import org.legacysaiku.olap.query.QueryProperties.QueryPropertyFactory;
	...
	public Properties getProperties() {
		...
		try {
			...
			if (query.getDimension("Scenario") != null) {
				this.properties.put("org.legacysaiku.connection.scenario", Boolean.toString(true));
			}
			else {
				this.properties.put("org.legacysaiku.connection.scenario", Boolean.toString(false));
			}
			this.properties.put("org.legacysaiku.query.explain", Boolean.toString(connection.isWrapperFor(RolapConnection.class)));
		} catch (Exception e) {
			this.properties.put("org.legacysaiku.connection.scenario", Boolean.toString(false));
			this.properties.put("org.legacysaiku.query.explain", Boolean.toString(false));
		}
